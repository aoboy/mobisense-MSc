...
typedef nx_struct routing_hdr {
  ...
  nx_uint8_t hopcount;
  nx_uint16_t seqno;
  nx_uint16_t orig_addr;
} __attribute__((packed)) routing_hdr_t;
...
typedef nx_struct monitor {
  ...
  nx_uint32_t nbytes;
  nx_uint8_t df1;
} __attribute__((packed)) monitor_t;
...
typedef TMilli ETXRoutingP$Timer0$precision_tag;
typedef TMilli ETXRoutingP$updateTimer$precision_tag;
typedef TMilli ETXDataForwarderP$MonitorTimer$precision_tag;
typedef TMilli ETXLinkLayerP$updtTimer$precision_tag;
enum AMQueueP$__nesc_unnamed4294 {
...
enum /*AlarmMultiplexC.Alarm.Alarm32khz32C.AlarmC.Msp430Timer*/Msp430Timer32khzC$0$__nesc_unnamed4295 {
...
enum /*HilTimerMilliC.AlarmMilli32C.AlarmFrom.Msp430Timer*/Msp430Timer32khzC$1$__nesc_unnamed4302 {
...
enum /*CC2420ReceiveC.Spi*/CC2420SpiC$4$__nesc_unnamed4303 {
  CC2420SpiC$4$CLIENT_ID = 4U
};
typedef uint16_t RandomMlcgC$SeedInit$parameter;
enum /*PlatformSerialC.UartC*/Msp430Uart1C$0$__nesc_unnamed4304 {
...
enum /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C$0$__nesc_unnamed4305 {
  Msp430Usart1C$0$CLIENT_ID = 0U
};
enum SerialAMQueueP$__nesc_unnamed4306 {
  SerialAMQueueP$NUM_CLIENTS = 1U
};
# 49 "/opt/tinyos-2.x/tos/interfaces/Boot.nc"
static void RootNodeP$Boot$booted(void );
# 92 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static void RootNodeP$SerialControl$startDone(error_t error);
#line 117
static void RootNodeP$SerialControl$stopDone(error_t error);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void RootNodeP$sendToUartTask$runTask(void );
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void RootNodeP$SerialSend$sendDone(
#line 92
message_t * msg, 
...
RootNodeP$Receive$receive(
# 22 "RootNodeP.nc"
am_id_t arg_0x405f3010, 
...
static void ETXRoutingP$Timer0$fired(void );
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void ETXRoutingP$SendBeaconTask$runTask(void );
# 41 "../Monitor.nc"
static bool ETXRoutingP$Monitor$isAuto(void );
#line 19
static uint32_t ETXRoutingP$Monitor$getNBytes(void );
#line 35
static void ETXRoutingP$Monitor$sendMonitor(void );
#line 27
static bool ETXRoutingP$Monitor$isSending(void );
#line 17
static void ETXRoutingP$Monitor$update(uint8_t nbytes);
...
static uint32_t ETXRoutingP$Monitor$getSenderTime(void );
#line 21
static uint32_t ETXRoutingP$Monitor$getNPackets(void );
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void ETXRoutingP$updateRouteETX$runTask(void );
#line 64
static void ETXRoutingP$SendMonitorTask$runTask(void );
# 15 "../DataSend.nc"
static void ETXRoutingP$Send$sendDone(message_t *p, error_t arg_0x4063c3f0);
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void ETXRoutingP$updateTimer$fired(void );
# 16 "../ReceiveBeacon.nc"
static message_t *ETXRoutingP$ReceiveBeacon$receive(message_t *arg_0x406501b8, void *arg_0x40650330, uint8_t arg_0x406504d0);
# 17 "../SendBeacon.nc"
static void ETXRoutingP$SendBeacon$sendDone(error_t err);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void ETXRoutingP$updateRouteRSSI$runTask(void );
# 17 "../NodeRole.nc"
static void ETXRoutingP$NodeRole$setNodeAsRouter(void );
# 74 "/opt/tinyos-2.x/tos/interfaces/StdControl.nc"
static error_t ETXRoutingP$StdControl$start(void );
# 31 "../Routing.nc"
static bool ETXRoutingP$Routing$getRootNode(void );
#line 23
static error_t ETXRoutingP$Routing$getNextHop(message_t *p, uint8_t opt);
#line 15
static void ETXRoutingP$Routing$init(void );



static void ETXRoutingP$Routing$setHeader(message_t *m);
...
static void ETXRoutingP$Routing$setRootNode(void );
...
static uint16_t ETXRoutingP$Routing$getParent(void );
# 92 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static void ETXDataForwarderP$SplitControl$startDone(error_t error);
#line 117
static void ETXDataForwarderP$SplitControl$stopDone(error_t error);
# 21 "../DataSend.nc"
static error_t ETXDataForwarderP$DataSend$send(message_t *p, uint8_t len);
#line 17
static void *ETXDataForwarderP$DataSend$getPayload(message_t *p, uint8_t len);
...
static void ETXDataForwarderP$DataSend$setPacketType(message_t *p, uint8_t type);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void ETXDataForwarderP$SubSend$sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void ETXDataForwarderP$ForwardPacketsTask$runTask(void );
#line 64
static void ETXDataForwarderP$relayPacketTask$runTask(void );
...
ETXDataForwarderP$Packet$getPayload(
#line 110
message_t * msg, 
...
static bool ETXDataForwarderP$Intercept$default$forward(
# 18 "../ETXDataForwarderP.nc"
am_id_t arg_0x406f2d60, 
...
ETXDataForwarderP$RecvData$receive(
#line 60
message_t * msg, 
void * payload, 
...
static error_t ETXDataForwarderP$Init$init(void );
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void ETXDataForwarderP$Forward$sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void ETXDataForwarderP$MonitorTimer$fired(void );
#line 72
static void ETXLinkLayerP$updtTimer$fired(void );
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static 
#line 63
message_t * 
...
ETXLinkLayerP$BeaconRcv$receive(
#line 60
message_t * msg, 
void * payload, 
...
uint8_t len);
# 27 "../LinkLayer.nc"
static void ETXLinkLayerP$LinkLayer$setNodeRole(uint8_t Role);
#line 17
static void ETXLinkLayerP$LinkLayer$initLinkLayer(void );
#line 38
static uint16_t ETXLinkLayerP$LinkLayer$getEtxByAddr(uint16_t addr);
#line 20
static void ETXLinkLayerP$LinkLayer$setRoot(void );
# 15 "../SendBeacon.nc"
static error_t ETXLinkLayerP$SendBeacon$send(uint16_t arg_0x40644e10, uint16_t arg_0x4063d010);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void ETXLinkLayerP$SendBcn$sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void ETXLinkLayerP$updateNeighborsTask$runTask(void );
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t /*MobilityC.BeaconSender.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
static void /*MobilityC.BeaconSender.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 85
message_t * msg, 
...
# 48 "/opt/tinyos-2.x/tos/chips/cc2420/lowpan/CC2420TinyosNetworkP.nc"
uint8_t arg_0x410fdaa0, 
# 60 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
message_t * msg, 
void * payload, 
...
uint8_t len);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t /*MobilityC.DataSender.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static void /*MobilityC.DataSender.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(
#line 85
message_t * msg, 
...
error_t error);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t /*MobilityC.DataSenderMine.AMQueueEntryP*/AMQueueEntryP$2$AMSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static void /*MobilityC.DataSenderMine.AMQueueEntryP*/AMQueueEntryP$2$Send$sendDone(
#line 85
message_t * msg, 
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t /*RootNodeC.SerialAM1.AMQueueEntryP*/AMQueueEntryP$3$AMSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static void /*RootNodeC.SerialAM1.AMQueueEntryP*/AMQueueEntryP$3$Send$sendDone(
#line 85
message_t * msg, 
...
# 83 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static error_t RootNodeP$SerialControl$start(void );
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t RootNodeP$sendToUartTask$postTask(void );
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t RootNodeP$SerialSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
static error_t RootNodeP$InitData$init(void );
# 89 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
static void RootNodeP$Leds$led2Toggle(void );
# 17 "../NodeRole.nc"
static void RootNodeP$NodeRole$setNodeAsRouter(void );
# 15 "../Routing.nc"
static void RootNodeP$Routing$init(void );
...
static void RootNodeP$Routing$setRootNode(void );
# 42 "RootNodeP.nc"
enum RootNodeP$__nesc_unnamed4307 {
#line 42
  RootNodeP$sendToUartTask = 0U
};
#line 42
typedef int RootNodeP$__nesc_sillytask_sendToUartTask[RootNodeP$sendToUartTask];
#line 31
enum RootNodeP$__nesc_unnamed4308 {
  RootNodeP$UART_BUFFER_LEN = 12
};

uint8_t RootNodeP$msgLengths[RootNodeP$UART_BUFFER_LEN];
message_t RootNodeP$uartQueueBufs[RootNodeP$UART_BUFFER_LEN];
message_t * RootNodeP$uartQueue[RootNodeP$UART_BUFFER_LEN];

uint8_t RootNodeP$uartIn;
#line 39
uint8_t RootNodeP$uartOut;
bool RootNodeP$uartFull;
#line 40
bool RootNodeP$uartBusy;


static inline message_t * RootNodeP$sendToUart(message_t * msg, void *payload, uint8_t len);

inline static void RootNodeP$Initialize(void );
...
static inline void RootNodeP$Boot$booted(void );
...
static inline void RootNodeP$SerialControl$startDone(error_t err);




static inline void RootNodeP$SerialControl$stopDone(error_t err);


static inline void RootNodeP$sendToUartTask$runTask(void );
#line 94
static void RootNodeP$SerialSend$sendDone(message_t *p, error_t err);
#line 109
static inline message_t * RootNodeP$sendToUart(message_t * msg, void *payload, uint8_t len);
#line 131
static inline message_t *RootNodeP$Receive$receive(am_id_t id, message_t *p, void *payload, uint8_t len);
# 125 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static uint32_t ETXRoutingP$Timer0$getNow(void );
#line 53
static void ETXRoutingP$Timer0$startPeriodic(uint32_t dt);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t ETXRoutingP$SendBeaconTask$postTask(void );
#line 56
static error_t ETXRoutingP$updateRouteETX$postTask(void );
#line 56
static error_t ETXRoutingP$SendMonitorTask$postTask(void );
# 115 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static 
#line 112
void * 
...
uint8_t len);
# 64 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Packet.nc"
static int8_t ETXRoutingP$CC2420Packet$getRssi(message_t *p_msg);
# 21 "../DataSend.nc"
static error_t ETXRoutingP$Send$send(message_t *p, uint8_t len);
#line 17
static void *ETXRoutingP$Send$getPayload(message_t *p, uint8_t len);
...
static void ETXRoutingP$Send$setPacketType(message_t *p, uint8_t type);
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void ETXRoutingP$updateTimer$startPeriodic(uint32_t dt);
# 27 "../LinkLayer.nc"
static void ETXRoutingP$LinkLayer$setNodeRole(uint8_t Role);
#line 17
static void ETXRoutingP$LinkLayer$initLinkLayer(void );
#line 38
static uint16_t ETXRoutingP$LinkLayer$getEtxByAddr(uint16_t addr);
#line 20
static void ETXRoutingP$LinkLayer$setRoot(void );
# 15 "../SendBeacon.nc"
static error_t ETXRoutingP$SendBeacon$send(uint16_t arg_0x40644e10, uint16_t arg_0x4063d010);
# 72 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
static void ETXRoutingP$Leds$led1Toggle(void );
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t ETXRoutingP$updateRouteRSSI$postTask(void );
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static am_addr_t ETXRoutingP$AMPacket$source(
#line 73
message_t * amsg);
#line 92
static void ETXRoutingP$AMPacket$setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 136
static am_id_t ETXRoutingP$AMPacket$type(
#line 132
message_t * amsg);
# 110 "../ETXRoutingP.nc"
enum ETXRoutingP$__nesc_unnamed4309 {
#line 110
  ETXRoutingP$SendBeaconTask = 1U
};
#line 110
typedef int ETXRoutingP$__nesc_sillytask_SendBeaconTask[ETXRoutingP$SendBeaconTask];

enum ETXRoutingP$__nesc_unnamed4310 {
#line 112
  ETXRoutingP$updateRouteETX = 2U
};
#line 112
typedef int ETXRoutingP$__nesc_sillytask_updateRouteETX[ETXRoutingP$updateRouteETX];

enum ETXRoutingP$__nesc_unnamed4311 {
#line 114
  ETXRoutingP$updateRouteRSSI = 3U
};
#line 114
typedef int ETXRoutingP$__nesc_sillytask_updateRouteRSSI[ETXRoutingP$updateRouteRSSI];

enum ETXRoutingP$__nesc_unnamed4312 {
#line 116
  ETXRoutingP$SendMonitorTask = 4U
};
#line 116
typedef int ETXRoutingP$__nesc_sillytask_SendMonitorTask[ETXRoutingP$SendMonitorTask];
#line 38
enum ETXRoutingP$__nesc_unnamed4313 {
  ETXRoutingP$INVALID_ADDR = 0xffff, 
  ETXRoutingP$INVALID_IDX = 0xf, 
  ETXRoutingP$INVALID_RSSI = -ETXRoutingP$INVALID_ADDR, 
  ETXRoutingP$RSSI_OFFSET = -45, 
  ETXRoutingP$RSSI_SWITCH = 10, 
  ETXRoutingP$ETX_THRESHOLD = 50
};



message_t ETXRoutingP$msg;



uint8_t ETXRoutingP$nodeRole;

bool ETXRoutingP$root_flag;
bool ETXRoutingP$radioBusy;

bool ETXRoutingP$initFlag;
bool ETXRoutingP$monitor;
bool ETXRoutingP$send_automatic;
bool ETXRoutingP$disableMonitor;
uint8_t ETXRoutingP$monitor_type;

uint16_t ETXRoutingP$currentParent;
uint16_t ETXRoutingP$currentETX;
uint16_t ETXRoutingP$currentRSSI;
uint8_t ETXRoutingP$currentIdx = 0;

uint16_t ETXRoutingP$currentSeqno;

uint8_t ETXRoutingP$nodeTTLValue;

uint32_t ETXRoutingP$totalBytes;
uint32_t ETXRoutingP$totalPackets;
uint16_t ETXRoutingP$monitorSeqno;
uint16_t ETXRoutingP$monitorInterval;

uint8_t ETXRoutingP$cyclicIdx;
uint8_t ETXRoutingP$duplicatedIdx;


uint16_t ETXRoutingP$duplicatedSenders[8];
uint16_t ETXRoutingP$duplicatedSeqno[8];

uint16_t ETXRoutingP$cyclicSenders[8];
uint16_t ETXRoutingP$cyclicSeqno[8];

routing_tbl_t ETXRoutingP$routingTable[8];


static inline void ETXRoutingP$initialize(void );





static __inline uint8_t ETXRoutingP$findAvailableEntry(void );

static __inline uint8_t ETXRoutingP$getIdx(uint16_t arg_0x40676598);

static inline uint16_t ETXRoutingP$getRssiInDbm(message_t *arg_0x40676b08);

static inline routing_hdr_t *ETXRoutingP$getRoutingHeader(message_t *m);

static inline void ETXRoutingP$addEntry(beacon_t *b, uint16_t src_addr, uint16_t rssi);

static void ETXRoutingP$updateEntry(beacon_t *b, uint16_t src_addr, uint8_t idx, uint16_t rssi);
#line 124
static inline routing_hdr_t *ETXRoutingP$getRoutingHeader(message_t *m);
...
static inline void ETXRoutingP$initialize(void );
#line 171
static inline uint16_t ETXRoutingP$getRssiInDbm(message_t *p);
...
static inline error_t ETXRoutingP$StdControl$start(void );
#line 194
static inline void ETXRoutingP$Routing$init(void );
#line 206
static inline void ETXRoutingP$Routing$setHeader(message_t *m);
#line 226
static error_t ETXRoutingP$Routing$getNextHop(message_t *p, uint8_t opt);
#line 274
static inline void ETXRoutingP$Routing$setRootNode(void );
#line 287
static inline bool ETXRoutingP$Routing$getRootNode(void );




static inline uint16_t ETXRoutingP$Routing$getParent(void );
#line 326
static __inline uint8_t ETXRoutingP$getIdx(uint16_t addr);
#line 341
static __inline uint8_t ETXRoutingP$findAvailableEntry(void );
#line 371
static void ETXRoutingP$updateEntry(beacon_t *b, uint16_t src_addr, uint8_t idx, uint16_t rssi);
...
static inline void ETXRoutingP$addEntry(beacon_t *b, uint16_t src_addr, uint16_t rssi);
#line 404
static inline void ETXRoutingP$SendBeaconTask$runTask(void );
#line 430
static inline void ETXRoutingP$SendBeacon$sendDone(error_t success);





static inline void ETXRoutingP$updateRouteETX$runTask(void );
#line 498
static inline void ETXRoutingP$updateRouteRSSI$runTask(void );
#line 551
static inline void ETXRoutingP$updateTimer$fired(void );
...
static inline void ETXRoutingP$Timer0$fired(void );
...
static inline message_t *ETXRoutingP$ReceiveBeacon$receive(message_t *p, void *payload, uint8_t len);
#line 640
static inline void ETXRoutingP$Monitor$update(uint8_t nbytes);
#line 653
static inline uint32_t ETXRoutingP$Monitor$getNBytes(void );




static inline uint32_t ETXRoutingP$Monitor$getNPackets(void );
...
static inline uint32_t ETXRoutingP$Monitor$getSenderTime(void );




static inline bool ETXRoutingP$Monitor$isSending(void );



static inline void ETXRoutingP$Monitor$sendMonitor(void );
#line 699
static inline bool ETXRoutingP$Monitor$isAuto(void );
#line 719
static inline void ETXRoutingP$NodeRole$setNodeAsRouter(void );
#line 738
static inline void ETXRoutingP$SendMonitorTask$runTask(void );
#line 760
static inline void ETXRoutingP$Send$sendDone(message_t *p, error_t err);
# 83 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static error_t ETXDataForwarderP$SplitControl$start(void );
# 15 "../DataSend.nc"
static void ETXDataForwarderP$DataSend$sendDone(message_t *p, error_t arg_0x4063c3f0);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t ETXDataForwarderP$SubSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 41 "../Monitor.nc"
static bool ETXDataForwarderP$Monitor$isAuto(void );
#line 35
static void ETXDataForwarderP$Monitor$sendMonitor(void );
#line 27
static bool ETXDataForwarderP$Monitor$isSending(void );
#line 17
static void ETXDataForwarderP$Monitor$update(uint8_t nbytes);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t ETXDataForwarderP$ForwardPacketsTask$postTask(void );
#line 56
static error_t ETXDataForwarderP$relayPacketTask$postTask(void );
# 31 "/opt/tinyos-2.x/tos/interfaces/Intercept.nc"
static bool ETXDataForwarderP$Intercept$forward(
# 18 "../ETXDataForwarderP.nc"
am_id_t arg_0x406f2d60, 
# 20 "/opt/tinyos-2.x/tos/interfaces/Intercept.nc"
message_t * msg, 
...
uint8_t len);
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static uint8_t ETXDataForwarderP$SubPacket$payloadLength(
#line 63
message_t * msg);
#line 115
static 
...
ETXDataForwarderP$SubPacket$getPayload(
#line 110
message_t * msg, 
...
uint8_t len);
#line 95
static uint8_t ETXDataForwarderP$SubPacket$maxPayloadLength(void );
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static 
#line 63
message_t * 
...
ETXDataForwarderP$Receive$receive(
# 17 "../ETXDataForwarderP.nc"
am_id_t arg_0x406f2708, 
# 60 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
message_t * msg, 
void * payload, 
...
uint8_t len);
# 89 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
static void ETXDataForwarderP$Leds$led2Toggle(void );
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t ETXDataForwarderP$Forward$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
static am_addr_t ETXDataForwarderP$AMPacket$address(void );
...
static am_addr_t ETXDataForwarderP$AMPacket$destination(
#line 63
message_t * amsg);
#line 136
static am_id_t ETXDataForwarderP$AMPacket$type(
#line 132
message_t * amsg);
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void ETXDataForwarderP$MonitorTimer$startPeriodic(uint32_t dt);
# 31 "../Routing.nc"
static bool ETXDataForwarderP$Routing$getRootNode(void );
#line 23
static error_t ETXDataForwarderP$Routing$getNextHop(message_t *p, uint8_t opt);
#line 19
static void ETXDataForwarderP$Routing$setHeader(message_t *m);
#line 33
static uint16_t ETXDataForwarderP$Routing$getParent(void );
# 61 "../ETXDataForwarderP.nc"
enum ETXDataForwarderP$__nesc_unnamed4314 {
#line 61
  ETXDataForwarderP$ForwardPacketsTask = 5U
};
#line 61
typedef int ETXDataForwarderP$__nesc_sillytask_ForwardPacketsTask[ETXDataForwarderP$ForwardPacketsTask];
#line 112
enum ETXDataForwarderP$__nesc_unnamed4315 {
#line 112
  ETXDataForwarderP$relayPacketTask = 6U
};
#line 112
typedef int ETXDataForwarderP$__nesc_sillytask_relayPacketTask[ETXDataForwarderP$relayPacketTask];
#line 40
enum ETXDataForwarderP$__nesc_unnamed4316 {
  ETXDataForwarderP$PKT_RET_CTR = 3
};


uint8_t ETXDataForwarderP$msgLengths[BUFR_QUEUE_LEN];
message_t ETXDataForwarderP$QueueBufs[BUFR_QUEUE_LEN];
message_t * ETXDataForwarderP$Queue[BUFR_QUEUE_LEN];

uint8_t ETXDataForwarderP$queueIn;
#line 49
uint8_t ETXDataForwarderP$queueOut;
bool ETXDataForwarderP$radioBusy;
#line 50
bool ETXDataForwarderP$radioFull;
#line 50
bool ETXDataForwarderP$sending;

uint8_t ETXDataForwarderP$failCtr;
uint8_t ETXDataForwarderP$maxRetrans;


static inline void ETXDataForwarderP$initialize(void );
static inline message_t *ETXDataForwarderP$forward_packet(message_t *p, uint8_t arg_0x406fa918);
static inline routing_hdr_t *ETXDataForwarderP$getHeader(message_t *p);
...
static inline void ETXDataForwarderP$MonitorTimer$fired(void );
...
static inline void ETXDataForwarderP$SplitControl$startDone(error_t err);




static inline void ETXDataForwarderP$SplitControl$stopDone(error_t err);





static inline void ETXDataForwarderP$relayPacketTask$runTask(void );
#line 126
static inline void ETXDataForwarderP$ForwardPacketsTask$runTask(void );
#line 143
static void ETXDataForwarderP$Forward$sendDone(message_t *p, error_t err);
#line 177
static inline message_t *ETXDataForwarderP$forward_packet(message_t *p, uint8_t len);
#line 204
static inline message_t *ETXDataForwarderP$RecvData$receive(message_t * p, void * payload, uint8_t len);
#line 225
static inline void *ETXDataForwarderP$Packet$getPayload(message_t *p, uint8_t len);
#line 254
static inline error_t ETXDataForwarderP$DataSend$send(message_t *p, uint8_t len);
#line 298
static void ETXDataForwarderP$SubSend$sendDone(message_t *p, error_t err);
#line 320
static inline void *ETXDataForwarderP$DataSend$getPayload(message_t *p, uint8_t len);



static inline void ETXDataForwarderP$DataSend$setPacketType(message_t *p, uint8_t type);
#line 350
static inline bool ETXDataForwarderP$Intercept$default$forward(am_id_t id, message_t *p, void *payload, uint8_t len);
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void ETXLinkLayerP$updtTimer$startPeriodic(uint32_t dt);
# 115 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static 
#line 112
void * 
...
ETXLinkLayerP$Packet$getPayload(
#line 110
message_t * msg, 
...
uint8_t len);
# 16 "../ReceiveBeacon.nc"
static message_t *ETXLinkLayerP$ReceiveBeacon$receive(message_t *arg_0x406501b8, void *arg_0x40650330, uint8_t arg_0x406504d0);
# 17 "../SendBeacon.nc"
static void ETXLinkLayerP$SendBeacon$sendDone(error_t err);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t ETXLinkLayerP$SendBcn$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 72 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
static void ETXLinkLayerP$Leds$led1Toggle(void );
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t ETXLinkLayerP$updateNeighborsTask$postTask(void );
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static am_addr_t ETXLinkLayerP$AMPacket$source(
#line 73
message_t * amsg);
#line 57
static am_addr_t ETXLinkLayerP$AMPacket$address(void );
#line 136
static am_id_t ETXLinkLayerP$AMPacket$type(
#line 132
message_t * amsg);
# 72 "../ETXLinkLayerP.nc"
enum ETXLinkLayerP$__nesc_unnamed4317 {
#line 72
  ETXLinkLayerP$updateNeighborsTask = 7U
};
#line 72
typedef int ETXLinkLayerP$__nesc_sillytask_updateNeighborsTask[ETXLinkLayerP$updateNeighborsTask];
#line 28
enum ETXLinkLayerP$__nesc_unnamed4318 {
  ETXLinkLayerP$INVALID_ADDR = 0xffff, 
  ETXLinkLayerP$INVALID_IDX = 0xf, 
  ETXLinkLayerP$ETX_THRESHOLD = 50
};

message_t ETXLinkLayerP$msg;

neighbor_tbl_t ETXLinkLayerP$neighbors[8];

bool ETXLinkLayerP$root_flag;
bool ETXLinkLayerP$radioBusy;



uint8_t ETXLinkLayerP$beaconSeqno;

uint8_t ETXLinkLayerP$nodeRole = ROUTER_ROLE;
uint8_t ETXLinkLayerP$nodeTTLValue;


static inline void ETXLinkLayerP$initialize(void );

static inline beacon_t *ETXLinkLayerP$getBeacon(message_t *p);



static __inline uint8_t ETXLinkLayerP$getIdx(uint16_t addr);



static inline uint8_t ETXLinkLayerP$findAvailableEntry(void );

static inline uint16_t ETXLinkLayerP$computeLinkETX(uint8_t dr, uint8_t df);



static inline void ETXLinkLayerP$setEntry(neighbor_tbl_t *entry, beacon_t *b, uint16_t *src_addr);

static inline void ETXLinkLayerP$updateEntry(beacon_t *b, uint16_t *src_addr, uint8_t idx);

static inline void ETXLinkLayerP$NeighborAddEntry(beacon_t *b, uint16_t *src_addr);
...
static inline void ETXLinkLayerP$NeighborAddEntry(beacon_t *b, uint16_t *src_addr);
#line 290
static inline void ETXLinkLayerP$LinkLayer$initLinkLayer(void );
...
static inline void ETXLinkLayerP$LinkLayer$setRoot(void );
...
static inline void ETXLinkLayerP$LinkLayer$setNodeRole(uint8_t role);
#line 335
static uint16_t ETXLinkLayerP$LinkLayer$getEtxByAddr(uint16_t addr);
#line 347
static inline uint8_t ETXLinkLayerP$findAvailableEntry(void );
#line 401
static inline error_t ETXLinkLayerP$SendBeacon$send(uint16_t etx, uint16_t parent);
#line 432
static inline void ETXLinkLayerP$SendBcn$sendDone(message_t *p, error_t success);





static inline message_t *ETXLinkLayerP$BeaconRcv$receive(message_t *p, void *payload, uint8_t len);
#line 458
static inline void ETXLinkLayerP$updateNeighborsTask$runTask(void );
#line 476
static inline void ETXLinkLayerP$updtTimer$fired(void );
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void /*MobilityC.BeaconSender.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static error_t /*MobilityC.BeaconSender.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 56
message_t * msg, 
...
static void /*MobilityC.BeaconSender.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*MobilityC.BeaconSender.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 147
message_t * amsg, 
...
static inline error_t /*MobilityC.BeaconSender.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*MobilityC.BeaconSender.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
...
enum /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$__nesc_unnamed4319 {
#line 118
...
#line 161
enum /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$__nesc_unnamed4320 {
#line 161
...
#line 49
#line 47
typedef struct /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$__nesc_unnamed4321 {
  message_t * msg;
} /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$queue_entry_t;

uint8_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current = 3;
/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$queue_entry_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$queue[3];
uint8_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$cancelMask[3 / 8 + 1];
...
uint8_t len);
# 61 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
...
enum Msp430ClockP$__nesc_unnamed4329 {
...
enum SchedulerBasicP$__nesc_unnamed4330 {

  SchedulerBasicP$NUM_TASKS = 30U, 
...
enum /*Counter32khz32C.Transform*/TransformCounterC$0$__nesc_unnamed4331 {
...
enum /*AlarmMultiplexC.Alarm.Alarm32khz32C.Transform*/TransformAlarmC$0$__nesc_unnamed4332 {
...
enum CC2420SpiP$__nesc_unnamed4335 {
  CC2420SpiP$S_IDLE, 
  CC2420SpiP$S_BUSY
};
...
enum StateImplP$__nesc_unnamed4336 {
  StateImplP$S_IDLE = 0
};
...
enum /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$__nesc_unnamed4337 {
#line 67
...
#line 56
enum /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$__nesc_unnamed4338 {
...
enum /*Msp430UsartShare0P.ArbiterC.Queue*/FcfsResourceQueueC$0$__nesc_unnamed4339 {
#line 39
...
enum /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$__nesc_unnamed4340 {
#line 75
...
#line 67
enum /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$__nesc_unnamed4341 {
#line 67
  ArbiterP$0$RES_CONTROLLED, ArbiterP$0$RES_GRANTING, ArbiterP$0$RES_IMM_GRANTING, ArbiterP$0$RES_BUSY
};
#line 68
enum /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$__nesc_unnamed4342 {
#line 68
  ArbiterP$0$default_owner_id = 1U
};
#line 69
enum /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$__nesc_unnamed4343 {
#line 69
...
#line 80
typedef enum CC2420TransmitP$__nesc_unnamed4344 {
...
enum CC2420TransmitP$__nesc_unnamed4345 {
...
# 115 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
...
#line 76
#line 70
typedef enum CC2420ReceiveP$__nesc_unnamed4347 {
...
enum /*CounterMilli32C.Transform*/TransformCounterC$1$__nesc_unnamed4349 {
...
enum /*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC$1$__nesc_unnamed4350 {
...
#line 60
  VirtualizeTimerC$0$updateFromTimer = 20U
};
#line 60
...
uint8_t len);
# 61 "/opt/tinyos-2.x/tos/chips/cc2420/lowpan/CC2420TinyosNetworkP.nc"
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void /*MobilityC.DataSender.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static error_t /*MobilityC.DataSender.AMQueueEntryP*/AMQueueEntryP$1$Send$send(
#line 56
message_t * msg, 
...
uint8_t len);
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static void /*MobilityC.DataSender.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*MobilityC.DataSender.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(
#line 147
message_t * amsg, 
...
am_id_t t);
# 45 "/opt/tinyos-2.x/tos/system/AMQueueEntryP.nc"
static inline error_t /*MobilityC.DataSender.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*MobilityC.DataSender.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(message_t *m, error_t err);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void /*MobilityC.DataSenderMine.AMQueueEntryP*/AMQueueEntryP$2$AMSend$sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static error_t /*MobilityC.DataSenderMine.AMQueueEntryP*/AMQueueEntryP$2$Send$send(
#line 56
message_t * msg, 
...
uint8_t len);
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static void /*MobilityC.DataSenderMine.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*MobilityC.DataSenderMine.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setType(
#line 147
message_t * amsg, 
...
am_id_t t);
# 45 "/opt/tinyos-2.x/tos/system/AMQueueEntryP.nc"
static error_t /*MobilityC.DataSenderMine.AMQueueEntryP*/AMQueueEntryP$2$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*MobilityC.DataSenderMine.AMQueueEntryP*/AMQueueEntryP$2$Send$sendDone(message_t *m, error_t err);
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
...
#line 335
  SerialP$defaultSerialFlushTask = 24U
};
#line 335
...
#line 109
typedef enum SerialP$__nesc_unnamed4365 {
...
#line 147
  SerialDispatcherP$0$signalSendDone = 25U
};
#line 147
...
#line 264
  SerialDispatcherP$0$receiveTask = 26U
};
#line 264
...
#line 55
#line 51
typedef enum /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$__nesc_unnamed4372 {
...
enum /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$__nesc_unnamed4373 {
...
#line 63
typedef struct /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$__nesc_unnamed4374 {
  uint8_t which : 1;
...
#line 44
typedef struct HdlcTranslateC$__nesc_unnamed4375 {
...
# 39 "/opt/tinyos-2.x/tos/system/FcfsResourceQueueC.nc"
enum /*Msp430UsartShare1P.ArbiterC.Queue*/FcfsResourceQueueC$1$__nesc_unnamed4376 {
#line 39
...
#line 69
enum /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP$1$__nesc_unnamed4380 {
#line 69
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void /*RootNodeC.SerialAM1.AMQueueEntryP*/AMQueueEntryP$3$AMSend$sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static error_t /*RootNodeC.SerialAM1.AMQueueEntryP*/AMQueueEntryP$3$Send$send(
#line 56
message_t * msg, 
...
uint8_t len);
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static void /*RootNodeC.SerialAM1.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*RootNodeC.SerialAM1.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setType(
#line 147
message_t * amsg, 
...
am_id_t t);
# 45 "/opt/tinyos-2.x/tos/system/AMQueueEntryP.nc"
static inline error_t /*RootNodeC.SerialAM1.AMQueueEntryP*/AMQueueEntryP$3$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*RootNodeC.SerialAM1.AMQueueEntryP*/AMQueueEntryP$3$Send$sendDone(message_t *m, error_t err);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
...
message_t * amsg);
# 118 "/opt/tinyos-2.x/tos/system/AMQueueImplP.nc"
enum /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$1$__nesc_unnamed4381 {
#line 118
  AMQueueImplP$1$CancelTask = 28U
};
#line 118
...
#line 161
enum /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$1$__nesc_unnamed4382 {
#line 161
  AMQueueImplP$1$errorTask = 29U
};
#line 161
...
#line 49
#line 47
typedef struct /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$1$__nesc_unnamed4383 {
  message_t * msg;
...
# 28 "/opt/tinyos-2.x/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP$0$Event$fired(uint8_t arg_0x40974088){
#line 28
  switch (arg_0x40974088) {
#line 28
    case 0:
#line 28
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP$0$Event$default$fired(arg_0x40974088);
#line 28
      break;
#line 28
    }
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerA0*/Msp430TimerCapComP$0$__nesc_unnamed4384 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerA1*/Msp430TimerCapComP$1$__nesc_unnamed4385 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerA2*/Msp430TimerCapComP$2$__nesc_unnamed4386 {
#line 47
    uint16_t f;
#line 47
...
#line 110
# 651 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline error_t CC2420TransmitP$releaseSpiResource(void )
#line 651
{
...
#line 32
# 477 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline void CC2420TransmitP$BackoffTimer$fired(void )
#line 477
{
  /* atomic removed: atomic calls only */
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB0*/Msp430TimerCapComP$3$__nesc_unnamed4387 {
#line 47
    uint16_t f;
#line 47
...
# 259 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline void CC2420ActiveMessageP$RadioBackoff$default$requestCongestionBackoff(am_id_t id, 
message_t *msg)
#line 260
{
...
# 88 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP$RadioBackoff$requestCongestionBackoff(am_id_t arg_0x40818400, message_t * msg){
#line 88
    CC2420ActiveMessageP$RadioBackoff$default$requestCongestionBackoff(arg_0x40818400, msg);
#line 88
}
#line 88
...
#line 41
# 231 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline void CC2420TransmitP$RadioBackoff$setCongestionBackoff(uint16_t backoffTime)
#line 231
{
...
# 118 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$isOwner(uint8_t arg_0x40d2d620){
#line 118
  unsigned char result;
#line 118

#line 118
  switch (arg_0x40d2d620) {
#line 118
...
#line 118
    default:
#line 118
      result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$isOwner(arg_0x40d2d620);
#line 118
      break;
#line 118
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Msp430SpiConfigure$getConfig(uint8_t arg_0x40d2c088){
#line 39
  union __nesc_unnamed4285 *result;
#line 39

#line 39
    result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Msp430SpiConfigure$default$getConfig(arg_0x40d2c088);
#line 39
...
# 49 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$configure(uint8_t arg_0x40e36430){
#line 49
  switch (arg_0x40e36430) {
#line 49
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$default$configure(arg_0x40e36430);
#line 49
      break;
#line 49
    }
...
# 51 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$immediateRequested(uint8_t arg_0x40e37010){
#line 51
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$default$immediateRequested(arg_0x40e37010);
#line 51
}
#line 51
...
# 87 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$immediateRequest(uint8_t arg_0x40d2d620){
#line 87
  unsigned char result;
#line 87
...
#line 87
    default:
#line 87
      result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$immediateRequest(arg_0x40d2d620);
#line 87
      break;
#line 87
    }
...
# 43 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$requested(uint8_t arg_0x40e37010){
#line 43
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$default$requested(arg_0x40e37010);
#line 43
}
#line 43
...
# 78 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$request(uint8_t arg_0x40d2d620){
#line 78
  unsigned char result;
#line 78
...
#line 78
    default:
#line 78
      result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$request(arg_0x40d2d620);
#line 78
      break;
#line 78
    }
...
#line 31
# 355 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline void CC2420TransmitP$ChipSpiResource$releasing(void )
#line 355
{
...
# 55 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$unconfigure(uint8_t arg_0x40e36430){
#line 55
  switch (arg_0x40e36430) {
#line 55
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
...
#line 55
    default:
#line 55
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$default$unconfigure(arg_0x40e36430);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$release(uint8_t arg_0x40d2d620){
#line 110
  unsigned char result;
#line 110
...
#line 110
    default:
#line 110
      result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$release(arg_0x40d2d620);
#line 110
      break;
#line 110
    }
...
{
#line 46
  union /*Msp430TimerC.Msp430TimerB1*/Msp430TimerCapComP$4$__nesc_unnamed4388 {
#line 46
...
#line 59
# 162 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static inline void CC2420ReceiveP$CC2420Receive$sfd_dropped(void )
#line 162
{
...
#line 43
# 99 "/opt/tinyos-2.x/tos/chips/cc2420/packet/CC2420PacketP.nc"
static inline cc2420_header_t * CC2420PacketP$CC2420PacketBody$getHeader(message_t * msg)
#line 99
{
...
#line 30
# 170 "/opt/tinyos-2.x/tos/chips/cc2420/packet/CC2420PacketP.nc"
static inline uint8_t CC2420PacketP$PacketTimeSyncOffset$get(message_t *msg)
{
...
# 103 "/opt/tinyos-2.x/tos/chips/cc2420/packet/CC2420PacketP.nc"
static inline cc2420_metadata_t *CC2420PacketP$CC2420PacketBody$getMetadata(message_t *msg)
#line 103
{
...
#line 98
# 239 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static __inline uint32_t CC2420TransmitP$getTime32(uint16_t time)
{
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB1*/Msp430TimerCapComP$4$__nesc_unnamed4389 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB2*/Msp430TimerCapComP$5$__nesc_unnamed4390 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB3*/Msp430TimerCapComP$6$__nesc_unnamed4391 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB4*/Msp430TimerCapComP$7$__nesc_unnamed4392 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB5*/Msp430TimerCapComP$8$__nesc_unnamed4393 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB6*/Msp430TimerCapComP$9$__nesc_unnamed4394 {
#line 47
    uint16_t f;
#line 47
...
#line 54
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*RootNodeC.SerialAM1.AMQueueEntryP*/AMQueueEntryP$3$AMSend$sendDone(message_t * msg, error_t error){
#line 99
  RootNodeP$SerialSend$sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*RootNodeC.SerialAM1.AMQueueEntryP*/AMQueueEntryP$3$AMSend$sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$1$Send$sendDone(uint8_t arg_0x407bec90, message_t * msg, error_t error){
#line 89
  switch (arg_0x407bec90) {
#line 89
    case 0U:
#line 89
      /*RootNodeC.SerialAM1.AMQueueEntryP*/AMQueueEntryP$3$Send$sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$1$Send$default$sendDone(arg_0x407bec90, msg, error);
#line 89
      break;
#line 89
    }
...
#line 56
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$1$AMSend$send(am_id_t arg_0x407bb730, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char result;
#line 69

#line 69
  result = /*SerialActiveMessageC.AM*/SerialActiveMessageP$0$AMSend$send(arg_0x407bb730, addr, msg, len);
#line 69
...
# 23 "/opt/tinyos-2.x/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$dataLinkLength(uart_id_t arg_0x41224cf0, message_t *msg, uint8_t upperLen){
#line 23
  unsigned char result;
#line 23

#line 23
  switch (arg_0x41224cf0) {
#line 23
...
#line 23
    default:
#line 23
      result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$default$dataLinkLength(arg_0x41224cf0, msg, upperLen);
#line 23
      break;
#line 23
    }
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$offset(uart_id_t arg_0x41224cf0){
#line 15
  unsigned char result;
#line 15
...
#line 15
    default:
#line 15
      result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$default$offset(arg_0x41224cf0);
#line 15
      break;
#line 15
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP$0$Resource$granted(uint8_t arg_0x4128bd40){
#line 92
  switch (arg_0x4128bd40) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430Uart1P.UartP*/Msp430UartP$0$Resource$default$granted(arg_0x4128bd40);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP$1$Resource$granted(uint8_t arg_0x40e39520){
#line 92
  switch (arg_0x40e39520) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP$1$Resource$default$granted(arg_0x40e39520);
#line 92
      break;
#line 92
    }
...
# 49 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP$1$ResourceConfigure$configure(uint8_t arg_0x40e36430){
#line 49
  switch (arg_0x40e36430) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C$0$CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP$1$ResourceConfigure$default$configure(arg_0x40e36430);
#line 49
      break;
#line 49
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart1P.UartP*/Msp430UartP$0$Msp430UartConfigure$getConfig(uint8_t arg_0x41285eb8){
#line 39
  union __nesc_unnamed4289 *result;
#line 39

#line 39
  switch (arg_0x41285eb8) {
#line 39
    case /*PlatformSerialC.UartC*/Msp430Uart1C$0$CLIENT_ID:
#line 39
...
#line 39
    default:
#line 39
      result = /*Msp430Uart1P.UartP*/Msp430UartP$0$Msp430UartConfigure$default$getConfig(arg_0x41285eb8);
#line 39
      break;
#line 39
    }
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP$0$AMSend$sendDone(am_id_t arg_0x4118c010, message_t * msg, error_t error){
#line 99
  /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$1$AMSend$sendDone(arg_0x4118c010, msg, error);
#line 99
}
#line 99
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$Send$sendDone(uart_id_t arg_0x412241f0, message_t * msg, error_t error){
#line 89
  switch (arg_0x412241f0) {
#line 89
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 89
...
#line 89
    default:
#line 89
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$Send$default$sendDone(arg_0x412241f0, msg, error);
#line 89
      break;
#line 89
    }
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP$0$Receive$receive(am_id_t arg_0x4118c9d0, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *result;
#line 67

#line 67
    result = /*SerialActiveMessageC.AM*/SerialActiveMessageP$0$Receive$default$receive(arg_0x4118c9d0, msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$Receive$receive(uart_id_t arg_0x41227b90, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *result;
#line 67

#line 67
  switch (arg_0x41227b90) {
#line 67
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 67
...
#line 67
    default:
#line 67
      result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$Receive$default$receive(arg_0x41227b90, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 31 "/opt/tinyos-2.x/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$upperLength(uart_id_t arg_0x41224cf0, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char result;
#line 31
...
#line 31
    default:
#line 31
      result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$default$upperLength(arg_0x41224cf0, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
#line 117
  RootNodeP$SerialControl$stopDone(error);
#line 117
}
#line 117
...
# 55 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP$1$ResourceConfigure$unconfigure(uint8_t arg_0x40e36430){
#line 55
  switch (arg_0x40e36430) {
#line 55
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C$0$CLIENT_ID:
...
#line 55
    default:
#line 55
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP$1$ResourceConfigure$default$unconfigure(arg_0x40e36430);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP$0$UsartResource$release(uint8_t arg_0x41285460){
#line 110
  unsigned char result;
#line 110

#line 110
  switch (arg_0x41285460) {
#line 110
    case /*PlatformSerialC.UartC*/Msp430Uart1C$0$CLIENT_ID:
#line 110
...
#line 110
    default:
#line 110
      result = /*Msp430Uart1P.UartP*/Msp430UartP$0$UsartResource$default$release(arg_0x41285460);
#line 110
      break;
#line 110
    }
...
# 118 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart1P.UartP*/Msp430UartP$0$UsartResource$isOwner(uint8_t arg_0x41285460){
#line 118
  unsigned char result;
#line 118
...
#line 118
    default:
#line 118
      result = /*Msp430Uart1P.UartP*/Msp430UartP$0$UsartResource$default$isOwner(arg_0x41285460);
#line 118
      break;
#line 118
    }
...
# 83 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
inline static error_t RootNodeP$SerialControl$start(void ){
#line 83
  unsigned char result;
#line 83
...
#line 92
  RootNodeP$SerialControl$startDone(error);
#line 92
}
#line 92
...
# 51 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP$1$ResourceRequested$immediateRequested(uint8_t arg_0x40e37010){
#line 51
    /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP$1$ResourceRequested$default$immediateRequested(arg_0x40e37010);
#line 51
}
#line 51
# 90 "/opt/tinyos-2.x/tos/system/ArbiterP.nc"
...
# 87 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP$0$UsartResource$immediateRequest(uint8_t arg_0x41285460){
#line 87
  unsigned char result;
#line 87
...
#line 87
    default:
#line 87
      result = /*Msp430Uart1P.UartP*/Msp430UartP$0$UsartResource$default$immediateRequest(arg_0x41285460);
#line 87
      break;
#line 87
    }
...
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static error_t ETXRoutingP$SendBeaconTask$postTask(void ){
#line 56
  unsigned char result;
#line 56

#line 56
  result = SchedulerBasicP$TaskBasic$postTask(ETXRoutingP$SendBeaconTask);
#line 56
...
#line 560
{
  ...
  if (ETXRoutingP$nodeRole == ROUTER_ROLE) {
      ETXRoutingP$SendBeaconTask$postTask();
    }
}

# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static error_t ETXRoutingP$updateRouteRSSI$postTask(void ){
#line 56
  unsigned char result;
#line 56

#line 56
  result = SchedulerBasicP$TaskBasic$postTask(ETXRoutingP$updateRouteRSSI);
#line 56
...
#line 56
inline static error_t ETXRoutingP$updateRouteETX$postTask(void ){
#line 56
  unsigned char result;
#line 56

#line 56
  result = SchedulerBasicP$TaskBasic$postTask(ETXRoutingP$updateRouteETX);
#line 56
...
{
  if (ETXRoutingP$nodeRole == ROUTER_ROLE) {
      ETXRoutingP$updateRouteETX$postTask();
    }
  else 
#line 554
    {

      ETXRoutingP$updateRouteRSSI$postTask();
    }
}

# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static error_t ETXLinkLayerP$updateNeighborsTask$postTask(void ){
#line 56
  unsigned char result;
#line 56

#line 56
  result = SchedulerBasicP$TaskBasic$postTask(ETXLinkLayerP$updateNeighborsTask);
#line 56
...
#line 56
# 476 "../ETXLinkLayerP.nc"
static inline void ETXLinkLayerP$updtTimer$fired(void )
#line 476
{
  ETXLinkLayerP$updateNeighborsTask$postTask();
}

# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static error_t ETXRoutingP$SendMonitorTask$postTask(void ){
#line 56
  unsigned char result;
#line 56

#line 56
  result = SchedulerBasicP$TaskBasic$postTask(ETXRoutingP$SendMonitorTask);
#line 56
...
#line 677
{
  ETXRoutingP$SendMonitorTask$postTask();
  ETXRoutingP$monitor = FALSE;
}

# 35 "../Monitor.nc"
inline static void ETXDataForwarderP$Monitor$sendMonitor(void ){
#line 35
  ETXRoutingP$Monitor$sendMonitor();
#line 35
}
#line 35
# 673 "../ETXRoutingP.nc"
...
#line 673
{
  return ETXRoutingP$monitor;
}

# 27 "../Monitor.nc"
inline static bool ETXDataForwarderP$Monitor$isSending(void ){
#line 27
  unsigned char result;
#line 27

#line 27
  result = ETXRoutingP$Monitor$isSending();
#line 27
...
#line 699
{
  return ETXRoutingP$send_automatic;
}

# 41 "../Monitor.nc"
inline static bool ETXDataForwarderP$Monitor$isAuto(void ){
#line 41
  unsigned char result;
#line 41

#line 41
  result = ETXRoutingP$Monitor$isAuto();
#line 41
...
#line 41
# 93 "../ETXDataForwarderP.nc"
static inline void ETXDataForwarderP$MonitorTimer$fired(void )
#line 93
{
  if (ETXDataForwarderP$Monitor$isAuto()) {
      if (ETXDataForwarderP$Monitor$isSending()) {
          ETXDataForwarderP$Monitor$sendMonitor();
        }
    }
}
...
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x41061030){
#line 72
  switch (arg_0x41061030) {
#line 72
    case 1U:
#line 72
      ETXRoutingP$Timer0$fired();
#line 72
      break;
#line 72
    case 2U:
#line 72
      ETXRoutingP$updateTimer$fired();
#line 72
      break;
#line 72
    case 3U:
#line 72
      ETXLinkLayerP$updtTimer$fired();
#line 72
      break;
#line 72
    case 4U:
#line 72
      ETXDataForwarderP$MonitorTimer$fired();
#line 72
      break;
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x41061030);
#line 72
      break;
#line 72
    }
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420TinyosNetworkP$NonTinyosReceive$receive(uint8_t arg_0x410fdaa0, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *result;
#line 67

#line 67
    result = CC2420TinyosNetworkP$NonTinyosReceive$default$receive(arg_0x410fdaa0, msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP$Snoop$receive(am_id_t arg_0x4081a308, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *result;
#line 67

#line 67
    result = CC2420ActiveMessageP$Snoop$default$receive(arg_0x4081a308, msg, payload, len);
#line 67
...
# 72 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
inline static void ETXLinkLayerP$Leds$led1Toggle(void ){
#line 72
...
# 64 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Packet.nc"
inline static int8_t ETXRoutingP$CC2420Packet$getRssi(message_t *p_msg){
#line 64
  signed char result;
#line 64
...
#line 171
{
  return (uint16_t )((uint16_t )ETXRoutingP$CC2420Packet$getRssi(p) + ETXRoutingP$RSSI_OFFSET);
}
...
#line 343
  ...
  for (k = 0; k < 8; k++) {
      if (ETXRoutingP$routingTable[k].active == 0) {
          return k;
        }
    }
  ...
  for (k = 0, n = 0; k < 8; k++) {
      if (ETXRoutingP$nodeRole == ROUTER_ROLE) {
          if (ETXRoutingP$routingTable[k].metric > min) {
              n = k;
              min = ETXRoutingP$routingTable[k].metric;
            }
        }
      else 
#line 358
        {
          if (ETXRoutingP$routingTable[k].ttl > maxTTL) {
              n = k;
              maxTTL = ETXRoutingP$routingTable[k].metric;
            }
        }
    }
...
#line 326
{
  ...
  for (k = 0; k < 8; k++) {
      ptr = &ETXRoutingP$routingTable[k];
      if (ptr->active == 1 && ptr->src == addr) {
          return k;
        }
    }

  return ETXRoutingP$INVALID_IDX;
}
...
#line 387
{
  ...
  idx = ETXRoutingP$getIdx(src_addr);

  if (idx < 8) {

      ETXRoutingP$updateEntry(b, src_addr, idx, rssi);
    }
  else {

      idx = ETXRoutingP$findAvailableEntry();
      ETXRoutingP$updateEntry(b, src_addr, idx, rssi);
    }
}

# 136 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static am_id_t ETXRoutingP$AMPacket$type(message_t * amsg){
#line 136
  unsigned char result;
#line 136
...
#line 136
#line 77
inline static am_addr_t ETXRoutingP$AMPacket$source(message_t * amsg){
#line 77
  unsigned int result;
#line 77

#line 77
  result = CC2420ActiveMessageP$AMPacket$source(amsg);
#line 77
...
#line 568
{
  ...
  uint16_t addr;
  beacon_t *bcn = (beacon_t *)ETXRoutingP$Packet$getPayload(p, sizeof(beacon_t ));

  if (ETXRoutingP$Routing$getRootNode()) {
      return p;
    }


  addr = ETXRoutingP$AMPacket$source(p);
  if (ETXRoutingP$AMPacket$type(p) == AM_BEACON_MSG && __nesc_ntoh_uint16(bcn->parent.data) != (uint16_t )TOS_NODE_ID) {
      ETXRoutingP$addEntry(bcn, addr, ETXRoutingP$getRssiInDbm(p));
      if (ETXRoutingP$nodeRole == MOBILE_ROLE) {
        }
    }
...
# 16 "../ReceiveBeacon.nc"
inline static message_t *ETXLinkLayerP$ReceiveBeacon$receive(message_t *arg_0x406501b8, void *arg_0x40650330, uint8_t arg_0x406504d0){
#line 16
  nx_struct message_t *result;
#line 16

#line 16
  result = ETXRoutingP$ReceiveBeacon$receive(arg_0x406501b8, arg_0x40650330, arg_0x406504d0);
#line 16
...
#line 206
    {
      ...
      entry->ttl = 0;
      entry->from = *src_addr;
      entry->lastseqno = __nesc_ntoh_uint8(b->seqno.data);
      entry->nrecvdbcn = 1;
      entry->nfaildbcn = 0;
...
#line 348
  ...
  for (k = 0; k < 8; k++) {
      if (ETXLinkLayerP$neighbors[k].active == 0) {
          return k;
        }
    }
  ...
  for (k = 0, idx = 0; k < 8; k++) {
      if (ETXLinkLayerP$neighbors[k].e_etx > min) {
          idx = k;
          min = ETXLinkLayerP$neighbors[k].e_etx;
        }
    }
...
#line 50
# 93 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline am_addr_t CC2420ActiveMessageP$AMPacket$address(void )
#line 93
{
...
# 57 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static am_addr_t ETXLinkLayerP$AMPacket$address(void ){
#line 57
  unsigned int result;
#line 57
...
#line 229
    {
      if (__nesc_ntoh_uint8(b->seqno.data) - ETXLinkLayerP$neighbors[idx].lastseqno < 0) {
          diffSeqno = (uint8_t )(256 - ETXLinkLayerP$neighbors[idx].lastseqno + __nesc_ntoh_uint8(b->seqno.data));
        }
      else 
#line 232
        {
          diffSeqno = (uint8_t )(__nesc_ntoh_uint8(b->seqno.data) - ETXLinkLayerP$neighbors[idx].lastseqno);
        }

      etxWindow = 3;

      ETXLinkLayerP$neighbors[idx].active = 1;
      ETXLinkLayerP$neighbors[idx].ttl = 0;
      ETXLinkLayerP$neighbors[idx].from = *src_addr;
      ETXLinkLayerP$neighbors[idx].parent = __nesc_ntoh_uint16(b->parent.data);
      ETXLinkLayerP$neighbors[idx].lastseqno = __nesc_ntoh_uint8(b->seqno.data);
      ETXLinkLayerP$neighbors[idx].nrecvdbcn = 1 + ETXLinkLayerP$neighbors[idx].nrecvdbcn;
      ETXLinkLayerP$neighbors[idx].nfaildbcn = ETXLinkLayerP$neighbors[idx].nfaildbcn + diffSeqno - 1;

      my_addr = ETXLinkLayerP$AMPacket$address();
      for (n = 0; n < 8; n++) {
          if (my_addr == __nesc_ntoh_uint16(b->neighbor[n].data)) {
              ETXLinkLayerP$neighbors[idx].etx_dr = __nesc_ntoh_uint8(b->etxs[n].data);
            }
        }

      if (diffSeqno >= 10) {
          ETXLinkLayerP$neighbors[idx].nrecvdbcn = 1;
          ETXLinkLayerP$neighbors[idx].nfaildbcn = 0;
          ETXLinkLayerP$neighbors[idx].e_etx = INVALID_ETX;
          ETXLinkLayerP$neighbors[idx].etx_df = 0;
          ETXLinkLayerP$neighbors[idx].etx_dr = 0;
        }
      if (ETXLinkLayerP$neighbors[idx].nrecvdbcn >= etxWindow) {
          ttlPkts = ETXLinkLayerP$neighbors[idx].nfaildbcn + ETXLinkLayerP$neighbors[idx].nrecvdbcn;
          if (ttlPkts < 3) {
              ttlPkts = 3;
            }
          etx = (uint8_t )(10 * ttlPkts / ETXLinkLayerP$neighbors[idx].nrecvdbcn);
          ETXLinkLayerP$neighbors[idx].etx_df = etx;
          ETXLinkLayerP$neighbors[idx].nfaildbcn = 0;
          ETXLinkLayerP$neighbors[idx].nrecvdbcn = 0;
          ETXLinkLayerP$neighbors[idx].e_etx = ETXLinkLayerP$computeLinkETX(ETXLinkLayerP$neighbors[idx].etx_dr, ETXLinkLayerP$neighbors[idx].etx_df);
        }
    }
#line 271
    __nesc_atomic_end(__nesc_atomic); }
...
#line 118
  for (k = 0; k < 8; k++) {
      if (ETXLinkLayerP$neighbors[k].active == 1 && ETXLinkLayerP$neighbors[k].from == addr) {
          return k;
        }
    }

  return ETXLinkLayerP$INVALID_IDX;
}
...
#line 275
{
  ...
  idx = ETXLinkLayerP$getIdx(*src_addr);

  if (idx < 8) {
      ETXLinkLayerP$updateEntry(b, src_addr, idx);
    }
  else 
#line 282
    {

      idx = ETXLinkLayerP$findAvailableEntry();
      ETXLinkLayerP$setEntry(&ETXLinkLayerP$neighbors[idx], b, src_addr);
    }
}

# 136 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static am_id_t ETXLinkLayerP$AMPacket$type(message_t * amsg){
#line 136
  unsigned char result;
#line 136
...
#line 136
#line 77
inline static am_addr_t ETXLinkLayerP$AMPacket$source(message_t * amsg){
#line 77
  unsigned int result;
#line 77
...
#line 114
# 74 "/opt/tinyos-2.x/tos/chips/cc2420/lowpan/CC2420TinyosNetworkP.nc"
static inline void *CC2420TinyosNetworkP$Send$getPayload(message_t *msg, uint8_t len)
#line 74
{
...
# 115 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
inline static void * ETXLinkLayerP$Packet$getPayload(message_t * msg, uint8_t len){
#line 115
  void *result;
#line 115
...
#line 115
# 438 "../ETXLinkLayerP.nc"
static inline message_t *ETXLinkLayerP$BeaconRcv$receive(message_t *p, void *payload, uint8_t len)
#line 438
{
  uint16_t src_addr;
  beacon_t *bcn = (beacon_t *)ETXLinkLayerP$Packet$getPayload(p, sizeof(beacon_t ));

  src_addr = ETXLinkLayerP$AMPacket$source(p);
  if (ETXLinkLayerP$AMPacket$type(p) == AM_BEACON_MSG) {
      if (ETXLinkLayerP$nodeRole == ROUTER_ROLE) {
          ETXLinkLayerP$NeighborAddEntry(bcn, &src_addr);
        }
      else 
#line 446
        {
      ...
      ETXLinkLayerP$ReceiveBeacon$receive(p, payload, len);
    }
  else {
      ETXLinkLayerP$Leds$led1Toggle();
    }
  return p;
}

# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static error_t ETXDataForwarderP$ForwardPacketsTask$postTask(void ){
#line 56
  unsigned char result;
#line 56

#line 56
  result = SchedulerBasicP$TaskBasic$postTask(ETXDataForwarderP$ForwardPacketsTask);
#line 56
...
#line 180
    {
      if (!ETXDataForwarderP$radioFull) {
          ret = ETXDataForwarderP$Queue[ETXDataForwarderP$queueIn];
          ETXDataForwarderP$Queue[ETXDataForwarderP$queueIn] = p;
          ETXDataForwarderP$msgLengths[ETXDataForwarderP$queueIn] = len;

          ETXDataForwarderP$queueIn = (ETXDataForwarderP$queueIn + 1) % BUFR_QUEUE_LEN;

          if (ETXDataForwarderP$queueIn == ETXDataForwarderP$queueOut) {
            ETXDataForwarderP$radioFull = TRUE;
            }
          if (!ETXDataForwarderP$radioBusy) {
              ETXDataForwarderP$ForwardPacketsTask$postTask();
              ETXDataForwarderP$radioBusy = TRUE;
            }
        }
      else 
#line 195
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
inline static void ETXDataForwarderP$Leds$led2Toggle(void ){
#line 89
  LedsP$Leds$led2Toggle();
#line 89
}
#line 89
# 350 "../ETXDataForwarderP.nc"
static inline bool ETXDataForwarderP$Intercept$default$forward(am_id_t id, message_t *p, void *payload, uint8_t len)
#line 350
{
  return TRUE;
...
# 31 "/opt/tinyos-2.x/tos/interfaces/Intercept.nc"
inline static bool ETXDataForwarderP$Intercept$forward(am_id_t arg_0x406f2d60, message_t * msg, void * payload, uint8_t len){
#line 31
  unsigned char result;
#line 31

#line 31
    result = ETXDataForwarderP$Intercept$default$forward(arg_0x406f2d60, msg, payload, len);
#line 31
...
#line 31
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static error_t RootNodeP$sendToUartTask$postTask(void ){
#line 56
  unsigned char result;
#line 56

#line 56
  result = SchedulerBasicP$TaskBasic$postTask(RootNodeP$sendToUartTask);
#line 56
...
#line 111
    {
      if (!RootNodeP$uartFull) {
          ret = RootNodeP$uartQueue[RootNodeP$uartIn];
          RootNodeP$uartQueue[RootNodeP$uartIn] = msg;
          RootNodeP$msgLengths[RootNodeP$uartIn] = len;

          RootNodeP$uartIn = (RootNodeP$uartIn + 1) % RootNodeP$UART_BUFFER_LEN;

          if (RootNodeP$uartIn == RootNodeP$uartOut) {
            RootNodeP$uartFull = TRUE;
            }
          if (!RootNodeP$uartBusy) {
              RootNodeP$sendToUartTask$postTask();
              RootNodeP$uartBusy = TRUE;
            }
        }
    }
#line 127
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
inline static void RootNodeP$Leds$led2Toggle(void ){
#line 89
  LedsP$Leds$led2Toggle();
#line 89
}
...
#line 131
{
  ...
  RootNodeP$Leds$led2Toggle();
  return RootNodeP$sendToUart(p, payload, len);
}

# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * ETXDataForwarderP$Receive$receive(am_id_t arg_0x406f2708, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *result;
#line 67

#line 67
  result = RootNodeP$Receive$receive(arg_0x406f2708, msg, payload, len);
#line 67
...
#line 67
# 31 "../Routing.nc"
inline static bool ETXDataForwarderP$Routing$getRootNode(void ){
#line 31
  unsigned char result;
#line 31

#line 31
  result = ETXRoutingP$Routing$getRootNode();
#line 31
...
#line 31
# 57 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static am_addr_t ETXDataForwarderP$AMPacket$address(void ){
#line 57
  unsigned int result;
#line 57
...
#line 57
#line 136
inline static am_id_t ETXDataForwarderP$AMPacket$type(message_t * amsg){
#line 136
  unsigned char result;
#line 136
...
#line 136
# 204 "../ETXDataForwarderP.nc"
static inline message_t *ETXDataForwarderP$RecvData$receive(message_t * p, void * payload, uint8_t len)
#line 204
{
  uint8_t id = ETXDataForwarderP$AMPacket$type(p);
  uint16_t addr = ETXDataForwarderP$AMPacket$destination(p);


  if (addr == 0xFFFF || addr != ETXDataForwarderP$AMPacket$address()) {
      return p;
    }


  if (ETXDataForwarderP$Routing$getRootNode()) {
      return ETXDataForwarderP$Receive$receive(id, p, payload, len);
    }
  else {
#line 216
    if (ETXDataForwarderP$Intercept$forward(id, p, payload, len)) {
        ETXDataForwarderP$Leds$led2Toggle();
        return ETXDataForwarderP$forward_packet(p, len);
      }
    else 
#line 219
      {
...
# 242 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline message_t *CC2420ActiveMessageP$Receive$default$receive(am_id_t id, message_t *msg, void *payload, uint8_t len)
#line 242
{
  return msg;
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP$Receive$receive(am_id_t arg_0x4081bc60, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *result;
#line 67

#line 67
  switch (arg_0x4081bc60) {
#line 67
    case 200:
#line 67
      result = ETXLinkLayerP$BeaconRcv$receive(msg, payload, len);
#line 67
      break;
#line 67
    case 201:
#line 67
      result = ETXDataForwarderP$RecvData$receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
#line 67
      result = CC2420ActiveMessageP$Receive$default$receive(arg_0x4081bc60, msg, payload, len);
#line 67
      break;
#line 67
    }
...
#line 42
# 97 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline am_addr_t CC2420ActiveMessageP$AMPacket$destination(message_t *amsg)
#line 97
{
...
#line 67
# 84 "/opt/tinyos-2.x/tos/chips/cc2420/lowpan/CC2420TinyosNetworkP.nc"
static inline message_t *CC2420TinyosNetworkP$SubReceive$receive(message_t *msg, void *payload, uint8_t len)
#line 84
{
...
#line 42
# 461 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static inline bool CC2420ReceiveP$passesAddressCheck(message_t *msg)
#line 461
{
...
#line 47
# 339 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static inline void CC2420ReceiveP$receiveDone_task$runTask(void )
#line 339
{
...
# 166 "/opt/tinyos-2.x/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static inline uint8_t CC2420CsmaP$Send$maxPayloadLength(void )
#line 166
{
  return 28;
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Resource$granted(uint8_t arg_0x40d328e0){
#line 92
  switch (arg_0x40d328e0) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C$0$CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Resource$default$granted(arg_0x40d328e0);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$Resource$granted(uint8_t arg_0x40e39520){
#line 92
  switch (arg_0x40e39520) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
...
#line 92
    default:
#line 92
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$Resource$default$granted(arg_0x40e39520);
#line 92
      break;
#line 92
    }
...
# 71 "/opt/tinyos-2.x/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$SpiPacket$sendDone(uint8_t arg_0x40d2ee10, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 71
  switch (arg_0x40d2ee10) {
#line 71
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C$0$CLIENT_ID:
#line 71
...
#line 71
    default:
#line 71
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$SpiPacket$default$sendDone(arg_0x40d2ee10, txBuf, rxBuf, len, error);
#line 71
      break;
#line 71
    }
...
# 465 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline void CC2420TransmitP$TXFIFO$readDone(uint8_t *tx_buf, uint8_t tx_len, 
error_t error)
#line 466
{
...
#line 47
# 367 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline void CC2420TransmitP$CC2420Receive$receive(uint8_t type, message_t *ack_msg)
#line 367
{
...
#line 110
# 199 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static inline void CC2420ReceiveP$RXFIFO$readDone(uint8_t *rx_buf, uint8_t rx_len, 
error_t error)
#line 200
{
...
# 71 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP$Fifo$readDone(uint8_t arg_0x40cab280, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x40cab280) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP$Fifo$default$readDone(arg_0x40cab280, data, length, error);
#line 71
      break;
#line 71
    }
...
#line 45
# 255 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline void CC2420ActiveMessageP$RadioBackoff$default$requestInitialBackoff(am_id_t id, 
message_t *msg)
#line 256
{
...
# 81 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP$RadioBackoff$requestInitialBackoff(am_id_t arg_0x40818400, message_t * msg){
#line 81
    CC2420ActiveMessageP$RadioBackoff$default$requestInitialBackoff(arg_0x40818400, msg);
#line 81
}
#line 81
...
#line 81
# 223 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline void CC2420TransmitP$RadioBackoff$setInitialBackoff(uint16_t backoffTime)
#line 223
{
...
#line 60
# 216 "/opt/tinyos-2.x/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static inline void CC2420CsmaP$SubBackoff$requestInitialBackoff(message_t *msg)
#line 216
{
...
#line 56
# 198 "/opt/tinyos-2.x/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static inline void CC2420CsmaP$CC2420Transmit$sendDone(message_t *p_msg, error_t err)
#line 198
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
#line 73
# 433 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline void CC2420TransmitP$TXFIFO$writeDone(uint8_t *tx_buf, uint8_t tx_len, 
error_t error)
#line 434
{
...
# 331 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static inline void CC2420ReceiveP$RXFIFO$writeDone(uint8_t *tx_buf, uint8_t tx_len, error_t error)
#line 331
{
}
...
# 91 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP$Fifo$writeDone(uint8_t arg_0x40cab280, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x40cab280) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP$Fifo$default$writeDone(arg_0x40cab280, data, length, error);
#line 91
      break;
#line 91
    }
...
# 395 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline void CC2420TransmitP$SpiResource$granted(void )
#line 395
{
  uint8_t cur_state;
...
# 190 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static inline void CC2420ReceiveP$SpiResource$granted(void )
#line 190
{
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void CC2420SpiP$Resource$granted(uint8_t arg_0x40cac818){
#line 92
  switch (arg_0x40cac818) {
#line 92
...
#line 92
    default:
#line 92
      CC2420SpiP$Resource$default$granted(arg_0x40cac818);
#line 92
      break;
#line 92
    }
...
#line 63
# 196 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline void CC2420ActiveMessageP$CC2420Config$syncDone(error_t error)
#line 196
{
}
...
#line 430
{
  ETXRoutingP$radioBusy = FALSE;
}

# 17 "../SendBeacon.nc"
inline static void ETXLinkLayerP$SendBeacon$sendDone(error_t err){
#line 17
  ETXRoutingP$SendBeacon$sendDone(err);
#line 17
}
#line 17
# 432 "../ETXLinkLayerP.nc"
static inline void ETXLinkLayerP$SendBcn$sendDone(message_t *p, error_t success)
#line 432
{
  ETXLinkLayerP$radioBusy = FALSE;
  ETXLinkLayerP$SendBeacon$sendDone(success);
}

# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*MobilityC.BeaconSender.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 99
  ETXLinkLayerP$SendBcn$sendDone(msg, error);
#line 99
}
#line 99
# 57 "/opt/tinyos-2.x/tos/system/AMQueueEntryP.nc"
...
#line 57
{
  /*MobilityC.BeaconSender.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}

# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*MobilityC.DataSender.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(message_t * msg, error_t error){
#line 99
  ETXDataForwarderP$Forward$sendDone(msg, error);
#line 99
}
#line 99
# 57 "/opt/tinyos-2.x/tos/system/AMQueueEntryP.nc"
...
#line 57
{
  /*MobilityC.DataSender.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(m, err);
}

# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*MobilityC.DataSenderMine.AMQueueEntryP*/AMQueueEntryP$2$AMSend$sendDone(message_t * msg, error_t error){
#line 99
  ETXDataForwarderP$SubSend$sendDone(msg, error);
#line 99
}
#line 99
# 57 "/opt/tinyos-2.x/tos/system/AMQueueEntryP.nc"
...
#line 57
{
  /*MobilityC.DataSenderMine.AMQueueEntryP*/AMQueueEntryP$2$AMSend$sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x407bec90, message_t * msg, error_t error){
#line 89
  switch (arg_0x407bec90) {
#line 89
    case 0U:
#line 89
      /*MobilityC.BeaconSender.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 89
      break;
#line 89
    case 1U:
#line 89
      /*MobilityC.DataSender.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(msg, error);
#line 89
      break;
#line 89
    case 2U:
#line 89
      /*MobilityC.DataSenderMine.AMQueueEntryP*/AMQueueEntryP$2$Send$sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x407bec90, msg, error);
#line 89
      break;
#line 89
    }
...
#line 181
{
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current >= 3) {
      return;
    }
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP$AMSend$sendDone(am_id_t arg_0x4081b2a0, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x4081b2a0, msg, error);
#line 99
}
#line 99
# 170 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline void CC2420ActiveMessageP$SubSend$sendDone(message_t *msg, error_t result)
#line 170
{
...
#line 89
# 79 "/opt/tinyos-2.x/tos/chips/cc2420/lowpan/CC2420TinyosNetworkP.nc"
static inline void CC2420TinyosNetworkP$SubSend$sendDone(message_t *msg, error_t error)
#line 79
{
...
#line 50
# 138 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static inline error_t CC2420ReceiveP$StdControl$stop(void )
#line 138
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
#line 84
# 268 "/opt/tinyos-2.x/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static inline void CC2420CsmaP$shutdown(void )
#line 268
{
...
#line 66
# 237 "/opt/tinyos-2.x/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static inline void CC2420CsmaP$sendDone_task$runTask(void )
#line 237
{
  error_t packetErr;
...
#line 59
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current = (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current + 1) % 3;
  for (i = 0; i < 3; i++) {
  ...
  if (i >= 3) {
#line 70
    /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current = 3;
    }
}
...
#line 67
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x407bb730, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char result;
#line 69

#line 69
  result = CC2420ActiveMessageP$AMSend$send(arg_0x407bb730, addr, msg, len);
#line 69
...
#line 70
# 253 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline void CC2420ActiveMessageP$SendNotifier$default$aboutToSend(am_id_t amId, am_addr_t addr, message_t *msg)
#line 253
{
}
...
# 59 "/opt/tinyos-2.x/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP$SendNotifier$aboutToSend(am_id_t arg_0x40819d38, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP$SendNotifier$default$aboutToSend(arg_0x40819d38, dest, msg);
#line 59
}
#line 59
...
# 526 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static inline error_t CC2420TransmitP$send(message_t * p_msg, bool cca)
#line 526
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
#line 51
# 263 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline void CC2420ActiveMessageP$RadioBackoff$default$requestCca(am_id_t id, 
message_t *msg)
#line 264
{
...
# 95 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP$RadioBackoff$requestCca(am_id_t arg_0x40818400, message_t * msg){
#line 95
    CC2420ActiveMessageP$RadioBackoff$default$requestCca(arg_0x40818400, msg);
#line 95
}
#line 95
# 211 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static inline void CC2420ActiveMessageP$SubBackoff$requestCca(message_t *msg)
#line 211
{
...
# 15 "../DataSend.nc"
inline static void ETXDataForwarderP$DataSend$sendDone(message_t *p, error_t arg_0x4063c3f0){
#line 15
  ETXRoutingP$Send$sendDone(p, arg_0x4063c3f0);
#line 15
}
#line 15
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void ETXRoutingP$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 92
  CC2420ActiveMessageP$AMPacket$setDestination(amsg, addr);
#line 92
}
#line 92
inline static void /*MobilityC.DataSenderMine.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 92
  CC2420ActiveMessageP$AMPacket$setDestination(amsg, addr);
#line 92
}
#line 92
#line 151
inline static void /*MobilityC.DataSenderMine.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setType(message_t * amsg, am_id_t t){
#line 151
...
#line 151
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static error_t /*MobilityC.DataSenderMine.AMQueueEntryP*/AMQueueEntryP$2$Send$send(message_t * msg, uint8_t len){
#line 64
  unsigned char result;
#line 64
...
#line 83
#line 67
inline static uint8_t ETXDataForwarderP$SubPacket$payloadLength(message_t * msg){
#line 67
  unsigned char result;
#line 67
...
#line 117
  ETXDataForwarderP$SplitControl$stopDone(error);
#line 117
}
#line 117
# 258 "/opt/tinyos-2.x/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static inline void CC2420CsmaP$stopDone_task$runTask(void )
#line 258
{
...
# 83 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
inline static error_t ETXDataForwarderP$SplitControl$start(void ){
#line 83
  unsigned char result;
#line 83
...
#line 83
# 101 "../ETXDataForwarderP.nc"
static inline void ETXDataForwarderP$SplitControl$startDone(error_t err)
#line 101
{
  if (err != SUCCESS) {
    ETXDataForwarderP$SplitControl$start();
    }
}
...
#line 92
  ETXDataForwarderP$SplitControl$startDone(error);
#line 92
}
#line 92
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
#line 43
# 124 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static inline error_t CC2420ReceiveP$StdControl$start(void )
#line 124
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
#line 74
# 250 "/opt/tinyos-2.x/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static inline void CC2420CsmaP$startDone_task$runTask(void )
#line 250
{
...
#line 458
{
  ...
  for (idx = 0; idx < 8; idx++) {
      entry = &ETXLinkLayerP$neighbors[idx];
      if (entry->active == 1) {
          entry->ttl++;
          if (entry->ttl >= ETXLinkLayerP$nodeTTLValue) {
              entry->active = 0;
              entry->etx_df = 0;
              entry->from = ETXLinkLayerP$INVALID_ADDR;
            }
        }
    }
}
...
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static error_t /*MobilityC.DataSender.AMQueueEntryP*/AMQueueEntryP$1$Send$send(message_t * msg, uint8_t len){
#line 64
  unsigned char result;
#line 64

#line 64
  result = /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$send(1U, msg, len);
#line 64
...
inline static void /*MobilityC.DataSender.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(message_t * amsg, am_id_t t){
#line 151
  CC2420ActiveMessageP$AMPacket$setType(amsg, t);
#line 151
}
#line 151
#line 92
inline static void /*MobilityC.DataSender.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 92
  CC2420ActiveMessageP$AMPacket$setDestination(amsg, addr);
#line 92
}
...
#line 47
{
  /*MobilityC.DataSender.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(msg, dest);
  /*MobilityC.DataSender.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(msg, 201);
  return /*MobilityC.DataSender.AMQueueEntryP*/AMQueueEntryP$1$Send$send(msg, len);
}

# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t ETXDataForwarderP$Forward$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char result;
#line 69

#line 69
  result = /*MobilityC.DataSender.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(addr, msg, len);
#line 69
...
#line 112
{
  ...
  p = ETXDataForwarderP$Queue[ETXDataForwarderP$queueOut];
  ETXDataForwarderP$maxRetrans = ETXDataForwarderP$PKT_RET_CTR;
  dest = ETXDataForwarderP$AMPacket$destination(p);

  if (ETXDataForwarderP$Forward$send(dest, ETXDataForwarderP$Queue[ETXDataForwarderP$queueOut], ETXDataForwarderP$msgLengths[ETXDataForwarderP$queueOut]) == SUCCESS) {
      ;
    }
}

# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static error_t ETXDataForwarderP$relayPacketTask$postTask(void ){
#line 56
  unsigned char result;
#line 56

#line 56
  result = SchedulerBasicP$TaskBasic$postTask(ETXDataForwarderP$relayPacketTask);
#line 56
...
#line 56
# 23 "../Routing.nc"
inline static error_t ETXDataForwarderP$Routing$getNextHop(message_t *p, uint8_t opt){
#line 23
  unsigned char result;
#line 23

#line 23
  result = ETXRoutingP$Routing$getNextHop(p, opt);
#line 23
...
#line 127
    {
      if (ETXDataForwarderP$queueIn == ETXDataForwarderP$queueOut && !ETXDataForwarderP$radioFull) {
          ETXDataForwarderP$radioBusy = FALSE;
          {
#line 130
            __nesc_atomic_end(__nesc_atomic); 
#line 130
...
#line 133
    __nesc_atomic_end(__nesc_atomic); }
  if (ETXDataForwarderP$Routing$getNextHop(ETXDataForwarderP$Queue[ETXDataForwarderP$queueOut], 0) == SUCCESS) {
      ETXDataForwarderP$relayPacketTask$postTask();
    }
  else 
#line 136
    {
...
# 72 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
inline static void ETXRoutingP$Leds$led1Toggle(void ){
#line 72
  LedsP$Leds$led1Toggle();
#line 72
}
...
#line 292
{
  return ETXRoutingP$currentParent;
}

# 33 "../Routing.nc"
inline static uint16_t ETXDataForwarderP$Routing$getParent(void ){
#line 33
  unsigned int result;
#line 33

#line 33
  result = ETXRoutingP$Routing$getParent();
#line 33
...
#line 33
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t ETXDataForwarderP$SubSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char result;
#line 69

#line 69
  result = /*MobilityC.DataSenderMine.AMQueueEntryP*/AMQueueEntryP$2$AMSend$send(addr, msg, len);
#line 69
...
#line 641
    {
      ETXRoutingP$totalPackets++;
      ETXRoutingP$totalBytes += nbytes;
    }
#line 644
    __nesc_atomic_end(__nesc_atomic); }
  if (ETXRoutingP$monitorInterval != 0 && ETXRoutingP$currentSeqno % ETXRoutingP$monitorInterval == 0) {
      if (ETXRoutingP$disableMonitor) {
          ETXRoutingP$monitor = TRUE;
        }
    }
}

# 17 "../Monitor.nc"
inline static void ETXDataForwarderP$Monitor$update(uint8_t nbytes){
#line 17
  ETXRoutingP$Monitor$update(nbytes);
#line 17
}
#line 17
# 124 "../ETXRoutingP.nc"
...
#line 124
{
  return (routing_hdr_t *)ETXRoutingP$Packet$getPayload(m, sizeof(routing_hdr_t ));
}
...
#line 206
{
  routing_hdr_t *hdr = ETXRoutingP$getRoutingHeader(m);


  __nesc_hton_uint8(hdr->hopcount.data, 1);
  __nesc_hton_uint16(hdr->seqno.data, ETXRoutingP$currentSeqno++);
  __nesc_hton_uint16(hdr->orig_addr.data, TOS_NODE_ID);
}

# 19 "../Routing.nc"
inline static void ETXDataForwarderP$Routing$setHeader(message_t *m){
#line 19
  ETXRoutingP$Routing$setHeader(m);
#line 19
}
#line 19
...
inline static uint8_t ETXDataForwarderP$SubPacket$maxPayloadLength(void ){
#line 95
  unsigned char result;
#line 95
...
#line 95
# 254 "../ETXDataForwarderP.nc"
static inline error_t ETXDataForwarderP$DataSend$send(message_t *p, uint8_t len)
#line 254
{
  len += sizeof(routing_hdr_t );

  if (len > ETXDataForwarderP$SubPacket$maxPayloadLength() || ETXDataForwarderP$Routing$getRootNode()) {
      return FAIL;
    }

  if (ETXDataForwarderP$sending == TRUE) {
      return EBUSY;
    }
  ...
  ETXDataForwarderP$Routing$setHeader(p);

  if (ETXDataForwarderP$Routing$getNextHop(p, 0) != SUCCESS) {
      return FAIL;
    }

  ETXDataForwarderP$Monitor$update(len);

  ETXDataForwarderP$failCtr = ETXDataForwarderP$PKT_RET_CTR;
  if (ETXDataForwarderP$SubSend$send(ETXDataForwarderP$Routing$getParent(), p, len) != SUCCESS) {
      ETXDataForwarderP$sending = TRUE;
      return FAIL;
    }
...
# 21 "../DataSend.nc"
inline static error_t ETXRoutingP$Send$send(message_t *p, uint8_t len){
#line 21
  unsigned char result;
#line 21

#line 21
  result = ETXDataForwarderP$DataSend$send(p, len);
#line 21
...
#line 21
# 64 "../ETXDataForwarderP.nc"
static inline routing_hdr_t *ETXDataForwarderP$getHeader(message_t *p)
#line 64
{
  return (routing_hdr_t *)ETXDataForwarderP$SubPacket$getPayload(p, sizeof(routing_hdr_t ));
}
...
#line 324
{
  routing_hdr_t *hdr = ETXDataForwarderP$getHeader(p);
...
# 25 "../DataSend.nc"
inline static void ETXRoutingP$Send$setPacketType(message_t *p, uint8_t type){
#line 25
  ETXDataForwarderP$DataSend$setPacketType(p, type);
#line 25
}
#line 25
# 653 "../ETXRoutingP.nc"
...
#line 658
{
  return ETXRoutingP$totalPackets;
}
...
# 125 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static uint32_t ETXRoutingP$Timer0$getNow(void ){
#line 125
  unsigned long result;
#line 125
...
#line 668
{
  return (uint32_t )ETXRoutingP$Timer0$getNow();
}

# 225 "../ETXDataForwarderP.nc"
static inline void *ETXDataForwarderP$Packet$getPayload(message_t *p, uint8_t len)
#line 225
{
  void *payload = ETXDataForwarderP$SubPacket$getPayload(p, len);

#line 227
  if (payload != (void *)0) {
      payload += sizeof(routing_hdr_t );
    }
  return payload;
}
...
#line 320
{
  return ETXDataForwarderP$Packet$getPayload(p, len);
}

# 17 "../DataSend.nc"
inline static void *ETXRoutingP$Send$getPayload(message_t *p, uint8_t len){
#line 17
  void *result;
#line 17

#line 17
  result = ETXDataForwarderP$DataSend$getPayload(p, len);
#line 17
...
#line 738
{
  ...
  monitor_t *p = ETXRoutingP$Send$getPayload(&ETXRoutingP$msg, sizeof(monitor_t ));

#line 742
  __nesc_hton_uint8(p->df0.data, 0x7E);
  __nesc_hton_uint16(p->seqno.data, ETXRoutingP$monitorSeqno);
  __nesc_hton_uint32(p->stime.data, ETXRoutingP$Monitor$getSenderTime());
  __nesc_hton_uint8(p->type.data, ETXRoutingP$monitor_type);
  __nesc_hton_uint32(p->npackets.data, ETXRoutingP$Monitor$getNPackets());
  __nesc_hton_uint32(p->nbytes.data, ETXRoutingP$Monitor$getNBytes());
  __nesc_hton_uint8(p->df1.data, 0x7E);

  ETXRoutingP$Send$setPacketType(&ETXRoutingP$msg, 1);
  returnVal = ETXRoutingP$Send$send(&ETXRoutingP$msg, len);
  if (returnVal == SUCCESS) {
      ETXRoutingP$monitorSeqno++;
      ETXRoutingP$Leds$led1Toggle();
    }
  else {
#line 755
    if (returnVal == EBUSY) {
...
{
  uint8_t k;
  uint8_t n = ETXRoutingP$INVALID_IDX;
  int16_t maxRssi = ETXRoutingP$INVALID_RSSI;
...
#line 507
        {
          entry = &ETXRoutingP$routingTable[k];
        }
#line 509
        __nesc_atomic_end(__nesc_atomic); }
      entry->ttl++;
      if (entry->ttl >= ETXRoutingP$nodeTTLValue) {
          entry->active = 0;
          continue;
        }
      if (entry->active == 0) {
...
#line 517
        {
          if (entry->active == 1 && entry->rssi > maxRssi && entry->src != ETXRoutingP$INVALID_ADDR) {
              n = k;
              addr = entry->src;
              maxRssi = entry->rssi;
            }
  ...
  if (n < 8) {
      if (ETXRoutingP$currentParent == addr) {
          { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 528
            {
              ETXRoutingP$currentParent = addr;
              ETXRoutingP$currentRSSI = (uint16_t )maxRssi;
            }
#line 531
            __nesc_atomic_end(__nesc_atomic); }
        }
...
#line 532
        {
          if (ETXRoutingP$currentParent == ETXRoutingP$INVALID_ADDR || ETXRoutingP$currentRSSI < maxRssi) {
              { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 534
                {
                  ETXRoutingP$currentParent = addr;
...
#line 542
        {
          ...
          ETXRoutingP$currentParent = ETXRoutingP$INVALID_ADDR;
          ETXRoutingP$currentRSSI = ETXRoutingP$INVALID_RSSI;
        }
#line 546
        __nesc_atomic_end(__nesc_atomic); }
    }
...
# 38 "../LinkLayer.nc"
inline static uint16_t ETXRoutingP$LinkLayer$getEtxByAddr(uint16_t addr){
#line 38
  unsigned int result;
#line 38

#line 38
  result = ETXLinkLayerP$LinkLayer$getEtxByAddr(addr);
#line 38
...
#line 439
  ...
  for (k = 0; k < 8; k++) 
    {
      ETXRoutingP$routingTable[k].ttl++;
      if (ETXRoutingP$routingTable[k].ttl >= ETXRoutingP$nodeTTLValue) {
          ETXRoutingP$routingTable[k].active = 0;
          continue;
        }
      if (ETXRoutingP$routingTable[k].active != 0) {

          if (ETXRoutingP$routingTable[k].src == ETXRoutingP$currentParent) {
              { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 454
                {
                  ETXRoutingP$currentParent = ETXRoutingP$routingTable[k].src;
                  ETXRoutingP$currentETX = ETXRoutingP$routingTable[k].metric;
                }
#line 457
                __nesc_atomic_end(__nesc_atomic); }
            }

          pathETX = ETXRoutingP$routingTable[k].metric + ETXRoutingP$LinkLayer$getEtxByAddr(ETXRoutingP$routingTable[k].src);

          if (pathETX < minETX) {
              n = k;
              addr = (uint16_t )ETXRoutingP$routingTable[k].src;
              minETX = pathETX;
            }
        }
    }
  ...
  if (n < 8) {
      if (ETXRoutingP$routingTable[n].src == ETXRoutingP$currentParent) {
          { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 473
            {
              ETXRoutingP$currentParent = ETXRoutingP$routingTable[n].src;
              ETXRoutingP$currentETX = ETXRoutingP$routingTable[n].metric;
              ETXRoutingP$currentIdx = n;
            }
#line 477
            __nesc_atomic_end(__nesc_atomic); }
        }
...
#line 478
        {
          if (minETX < ETXRoutingP$currentETX) {
              { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 480
                {
                  ETXRoutingP$currentParent = ETXRoutingP$routingTable[n].src;
                  ETXRoutingP$currentETX = (uint8_t )minETX;
                  ETXRoutingP$currentIdx = n;
                }
#line 484
                __nesc_atomic_end(__nesc_atomic); }
...
#line 488
        {
          ...
          ETXRoutingP$currentParent = ETXRoutingP$INVALID_ADDR;
          ETXRoutingP$currentETX = INVALID_ETX;
          ETXRoutingP$currentIdx = ETXRoutingP$INVALID_IDX;
        }
#line 493
        __nesc_atomic_end(__nesc_atomic); }
    }
...
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static error_t /*MobilityC.BeaconSender.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 64
  unsigned char result;
#line 64
...
#line 64
# 151 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*MobilityC.BeaconSender.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 151
  CC2420ActiveMessageP$AMPacket$setType(amsg, t);
#line 151
}
#line 151
#line 92
inline static void /*MobilityC.BeaconSender.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 92
  CC2420ActiveMessageP$AMPacket$setDestination(amsg, addr);
#line 92
}
...
#line 47
{
  /*MobilityC.BeaconSender.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*MobilityC.BeaconSender.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 200);
  return /*MobilityC.BeaconSender.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t ETXLinkLayerP$SendBcn$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char result;
#line 69

#line 69
  result = /*MobilityC.BeaconSender.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 69
...
#line 75
{
  return (beacon_t *)ETXLinkLayerP$Packet$getPayload(p, sizeof(beacon_t ));
}
...
static inline error_t ETXLinkLayerP$SendBeacon$send(uint16_t etx, uint16_t parent)
{
  uint8_t k;
  neighbor_tbl_t *ptr;
  beacon_t *beacon = ETXLinkLayerP$getBeacon(&ETXLinkLayerP$msg);

  if (ETXLinkLayerP$radioBusy || ETXLinkLayerP$nodeRole == MOBILE_ROLE) {
      return FAIL;
    }

  if (ETXLinkLayerP$root_flag) {
      __nesc_hton_uint8(beacon->seqno.data, ETXLinkLayerP$beaconSeqno++);
      __nesc_hton_uint8(beacon->metric.data, (uint8_t )0);
      __nesc_hton_uint16(beacon->parent.data, (uint16_t )parent);
    }
  else 
#line 415
    {
      __nesc_hton_uint8(beacon->seqno.data, ETXLinkLayerP$beaconSeqno++);
      __nesc_hton_uint8(beacon->metric.data, (uint8_t )(etx + (uint8_t )ETXLinkLayerP$LinkLayer$getEtxByAddr(parent)));
      __nesc_hton_uint16(beacon->parent.data, parent);
    }

  for (k = 0; k < 8; k++) {
      ptr = &ETXLinkLayerP$neighbors[k];
      __nesc_hton_uint8(beacon->etxs[k].data, ptr->etx_df);
      __nesc_hton_uint16(beacon->neighbor[k].data, ptr->from);
    }
  ETXLinkLayerP$radioBusy = TRUE;
  return ETXLinkLayerP$SendBcn$send(0xFFFF, &ETXLinkLayerP$msg, sizeof(beacon_t ));
}

# 15 "../SendBeacon.nc"
inline static error_t ETXRoutingP$SendBeacon$send(uint16_t arg_0x40644e10, uint16_t arg_0x4063d010){
#line 15
  unsigned char result;
#line 15

#line 15
  result = ETXLinkLayerP$SendBeacon$send(arg_0x40644e10, arg_0x4063d010);
#line 15
...
#line 404
{
  ...
  if (ETXRoutingP$radioBusy) {
      return;
    }

  if (ETXRoutingP$root_flag) {
      linkEtx = 0;
      ETXRoutingP$currentParent = (uint16_t )TOS_NODE_ID;
    }
  else {
#line 415
    if (ETXRoutingP$currentParent == ETXRoutingP$INVALID_ADDR) {
        linkEtx = INVALID_ETX;
      }
    else 
#line 417
      {
        linkEtx = ETXRoutingP$currentETX;
      }
    }
  if (ETXRoutingP$SendBeacon$send(linkEtx, ETXRoutingP$currentParent) == SUCCESS) {
      if (ETXRoutingP$nodeRole == ROUTER_ROLE) {
          ETXRoutingP$Leds$led1Toggle();
        }
      ETXRoutingP$radioBusy = TRUE;
    }
}
...
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static error_t /*RootNodeC.SerialAM1.AMQueueEntryP*/AMQueueEntryP$3$Send$send(message_t * msg, uint8_t len){
#line 64
  unsigned char result;
#line 64
...
# 151 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*RootNodeC.SerialAM1.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setType(message_t * amsg, am_id_t t){
#line 151
...
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*RootNodeC.SerialAM1.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
#line 47
{
  /*RootNodeC.SerialAM1.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setDestination(msg, dest);
  /*RootNodeC.SerialAM1.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setType(msg, 10);
  return /*RootNodeC.SerialAM1.AMQueueEntryP*/AMQueueEntryP$3$Send$send(msg, len);
}

# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t RootNodeP$SerialSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char result;
#line 69

#line 69
  result = /*RootNodeC.SerialAM1.AMQueueEntryP*/AMQueueEntryP$3$AMSend$send(addr, msg, len);
#line 69
...
#line 76
    {
      if (RootNodeP$uartIn == RootNodeP$uartOut && !RootNodeP$uartFull) {
          RootNodeP$uartBusy = FALSE;
          {
#line 79
            __nesc_atomic_end(__nesc_atomic); 
#line 79
...
#line 82
    __nesc_atomic_end(__nesc_atomic); }
  len = RootNodeP$msgLengths[RootNodeP$uartOut];

  if (RootNodeP$SerialSend$send(0xffff, RootNodeP$uartQueue[RootNodeP$uartOut], len) == SUCCESS) {
      ;
    }
  else {
...
{
#line 46
  union /*Msp430TimerC.Msp430TimerB0*/Msp430TimerCapComP$3$__nesc_unnamed4395 {
#line 46
...
#line 51
  result = ecombine(result, ETXDataForwarderP$Init$init());
#line 51
...
#line 69
{
  ...
  for (i = 0; i < BUFR_QUEUE_LEN; i++) {
      ETXDataForwarderP$Queue[i] = &ETXDataForwarderP$QueueBufs[i];
      ETXDataForwarderP$msgLengths[i] = 0;
    }
  ETXDataForwarderP$queueIn = ETXDataForwarderP$queueOut = 0;
  ETXDataForwarderP$radioBusy = FALSE;
  ETXDataForwarderP$radioFull = FALSE;
  ETXDataForwarderP$sending = FALSE;

  ETXDataForwarderP$failCtr = ETXDataForwarderP$maxRetrans = 0;
}

# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void ETXDataForwarderP$MonitorTimer$startPeriodic(uint32_t dt){
#line 53
...
#line 47
  for (k = 0; k < RootNodeP$UART_BUFFER_LEN; k++) {
      RootNodeP$msgLengths[k] = 0;
      RootNodeP$uartQueue[k] = &RootNodeP$uartQueueBufs[k];
    }

  RootNodeP$uartIn = RootNodeP$uartOut = 0;
  RootNodeP$uartFull = RootNodeP$uartBusy = FALSE;
}

# 308 "../ETXLinkLayerP.nc"
static inline void ETXLinkLayerP$LinkLayer$setNodeRole(uint8_t role)
#line 308
{
  ETXLinkLayerP$nodeRole = role;
  if (role == ROUTER_ROLE) {
      ETXLinkLayerP$nodeTTLValue = 6;
    }
}

# 27 "../LinkLayer.nc"
inline static void ETXRoutingP$LinkLayer$setNodeRole(uint8_t Role){
#line 27
  ETXLinkLayerP$LinkLayer$setNodeRole(Role);
#line 27
}
#line 27
# 719 "../ETXRoutingP.nc"
...
#line 719
{
  ETXRoutingP$nodeRole = ROUTER_ROLE;
  ETXRoutingP$nodeTTLValue = 6;
  ETXRoutingP$LinkLayer$setNodeRole(ETXRoutingP$nodeRole);
}

# 17 "../NodeRole.nc"
inline static void RootNodeP$NodeRole$setNodeAsRouter(void ){
#line 17
  ETXRoutingP$NodeRole$setNodeAsRouter();
#line 17
}
#line 17
# 297 "../ETXLinkLayerP.nc"
static inline void ETXLinkLayerP$LinkLayer$setRoot(void )
#line 297
{
  ETXLinkLayerP$root_flag = TRUE;
  ETXLinkLayerP$nodeRole = ROUTER_ROLE;
  ETXLinkLayerP$nodeTTLValue = 6;
}

# 20 "../LinkLayer.nc"
inline static void ETXRoutingP$LinkLayer$setRoot(void ){
#line 20
  ETXLinkLayerP$LinkLayer$setRoot();
#line 20
}
#line 20
# 274 "../ETXRoutingP.nc"
...
#line 274
{
  ETXRoutingP$root_flag = TRUE;
  ETXRoutingP$LinkLayer$setRoot();
}

# 26 "../Routing.nc"
inline static void RootNodeP$Routing$setRootNode(void ){
#line 26
  ETXRoutingP$Routing$setRootNode();
#line 26
}
#line 26
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
inline static error_t RootNodeP$InitData$init(void ){
#line 51
  unsigned char result;
#line 51

#line 51
  result = ETXDataForwarderP$Init$init();
#line 51
...
#line 51
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void ETXRoutingP$updateTimer$startPeriodic(uint32_t dt){
#line 53
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startPeriodic(2U, dt);
#line 53
}
#line 53
inline static void ETXRoutingP$Timer0$startPeriodic(uint32_t dt){
#line 53
...
#line 180
{
  ETXRoutingP$Timer0$startPeriodic(1024);
  ETXRoutingP$updateTimer$startPeriodic(512);
  return SUCCESS;
}

# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void ETXLinkLayerP$updtTimer$startPeriodic(uint32_t dt){
#line 53
...
#line 82
  for (k = 0; k < 8; k++) {
      ETXLinkLayerP$neighbors[k].parent = ETXLinkLayerP$INVALID_ADDR;
      ETXLinkLayerP$neighbors[k].active = 0;
      ETXLinkLayerP$neighbors[k].lastseqno = 0;
      ETXLinkLayerP$neighbors[k].ttl = 0;
      ETXLinkLayerP$neighbors[k].nrecvdbcn = 0;
      ETXLinkLayerP$neighbors[k].nfaildbcn = 0;
      ETXLinkLayerP$neighbors[k].from = ETXLinkLayerP$INVALID_ADDR;
      ETXLinkLayerP$neighbors[k].parent = ETXLinkLayerP$INVALID_ADDR;
      ETXLinkLayerP$neighbors[k].e_etx = INVALID_ETX;
      ETXLinkLayerP$neighbors[k].etx_df = 0;
      ETXLinkLayerP$neighbors[k].etx_dr = 0;
      ETXLinkLayerP$neighbors[k].total = 0;
      ETXLinkLayerP$neighbors[k].data_ctr = 0;
    }

  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 98
    {
      ETXLinkLayerP$beaconSeqno = 0;
      ETXLinkLayerP$nodeTTLValue = 6;
    }
#line 101
    __nesc_atomic_end(__nesc_atomic); }
...
#line 290
{
  ETXLinkLayerP$initialize();
  ETXLinkLayerP$nodeRole = ROUTER_ROLE;
  ETXLinkLayerP$updtTimer$startPeriodic(1024);
}

# 17 "../LinkLayer.nc"
inline static void ETXRoutingP$LinkLayer$initLinkLayer(void ){
#line 17
  ETXLinkLayerP$LinkLayer$initLinkLayer();
#line 17
}
#line 17
# 129 "../ETXRoutingP.nc"
...
#line 131
  for (k = 0; k < 8; k++) {
      ETXRoutingP$routingTable[k].parent = ETXRoutingP$INVALID_ADDR;
      ETXRoutingP$routingTable[k].src = ETXRoutingP$INVALID_ADDR;
      ETXRoutingP$routingTable[k].active = 0;
      ETXRoutingP$routingTable[k].ttl = 0;
      ETXRoutingP$routingTable[k].metric = INVALID_ETX;
      ETXRoutingP$routingTable[k].rssi = 0;
    }
...
#line 140
    {
      ...
      ETXRoutingP$cyclicIdx = 0;
      ETXRoutingP$duplicatedIdx = 0;

      ETXRoutingP$nodeRole = ROUTER_ROLE;
      ETXRoutingP$nodeTTLValue = 6;

      ETXRoutingP$initFlag = FALSE;
      ETXRoutingP$monitor = FALSE;
      ETXRoutingP$root_flag = FALSE;
      ETXRoutingP$disableMonitor = FALSE;
      ETXRoutingP$send_automatic = FALSE;
      ETXRoutingP$monitor_type = 0;

      ETXRoutingP$currentSeqno = 0;

      ETXRoutingP$totalBytes = 0;
      ETXRoutingP$totalPackets = 0;
      ETXRoutingP$monitorSeqno = 0;
      ETXRoutingP$monitorInterval = 75;
...
#line 194
{
  ETXRoutingP$initialize();
  ETXRoutingP$LinkLayer$initLinkLayer();
  ETXRoutingP$StdControl$start();
}

# 15 "../Routing.nc"
inline static void RootNodeP$Routing$init(void ){
#line 15
  ETXRoutingP$Routing$init();
#line 15
}
#line 15
# 56 "RootNodeP.nc"
...
#line 56
{
  RootNodeP$Routing$init();
  RootNodeP$InitData$init();
  RootNodeP$Routing$setRootNode();
  RootNodeP$NodeRole$setNodeAsRouter();
  RootNodeP$Initialize();
  RootNodeP$SerialControl$start();
}
...
#line 54
  result = Msp430ClockP$McuPowerOverride$lowestState();
#line 54
...
#line 61
# 179 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static inline void CC2420ReceiveP$InterruptFIFOP$fired(void )
#line 179
{
...
# 54 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$rxDone(uint8_t arg_0x40e2a758, uint8_t data){
#line 54
  switch (arg_0x40e2a758) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$default$rxDone(arg_0x40e2a758, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$I2CInterrupts$fired(uint8_t arg_0x40e29010){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$I2CInterrupts$default$fired(arg_0x40e29010);
#line 39
}
#line 39
...
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$txDone(uint8_t arg_0x40e2a758){
#line 49
  switch (arg_0x40e2a758) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$default$txDone(arg_0x40e2a758);
#line 49
      break;
#line 49
    }
...
# 79 "/opt/tinyos-2.x/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP$0$UartStream$receivedByte(uint8_t arg_0x41286010, uint8_t byte){
#line 79
  switch (arg_0x41286010) {
#line 79
    case /*PlatformSerialC.UartC*/Msp430Uart1C$0$CLIENT_ID:
#line 79
...
#line 79
    default:
#line 79
      /*Msp430Uart1P.UartP*/Msp430UartP$0$UartStream$default$receivedByte(arg_0x41286010, byte);
#line 79
      break;
#line 79
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP$0$UartStream$receiveDone(uint8_t arg_0x41286010, uint8_t * buf, uint16_t len, error_t error){
#line 99
  switch (arg_0x41286010) {
#line 99
    case /*PlatformSerialC.UartC*/Msp430Uart1C$0$CLIENT_ID:
...
#line 99
    default:
#line 99
      /*Msp430Uart1P.UartP*/Msp430UartP$0$UartStream$default$receiveDone(arg_0x41286010, buf, len, error);
#line 99
      break;
#line 99
    }
...
# 54 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP$1$Interrupts$rxDone(uint8_t arg_0x40e2a758, uint8_t data){
#line 54
  switch (arg_0x40e2a758) {
#line 54
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C$0$CLIENT_ID:
...
#line 54
    default:
#line 54
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP$1$Interrupts$default$rxDone(arg_0x40e2a758, data);
#line 54
      break;
#line 54
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP$0$UartStream$sendDone(uint8_t arg_0x41286010, uint8_t * buf, uint16_t len, error_t error){
#line 57
  switch (arg_0x41286010) {
#line 57
    case /*PlatformSerialC.UartC*/Msp430Uart1C$0$CLIENT_ID:
...
#line 57
    default:
#line 57
      /*Msp430Uart1P.UartP*/Msp430UartP$0$UartStream$default$sendDone(arg_0x41286010, buf, len, error);
#line 57
      break;
#line 57
    }
...
# 49 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP$1$Interrupts$txDone(uint8_t arg_0x40e2a758){
#line 49
  switch (arg_0x40e2a758) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C$0$CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP$1$Interrupts$default$txDone(arg_0x40e2a758);
#line 49
      break;
#line 49
    }
...
# 28 "/opt/tinyos-2.x/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP$1$Event$fired(uint8_t arg_0x40974088){
#line 28
  switch (arg_0x40974088) {
#line 28
    case 0:
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP$1$Event$default$fired(arg_0x40974088);
#line 28
      break;
#line 28
    }
...
# 636 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static void CC2420TransmitP$congestionBackoff(void )
#line 636
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 643 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static error_t CC2420TransmitP$acquireSpiResource(void )
#line 643
{
...
# 594 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static void CC2420TransmitP$attemptSend(void )
#line 594
{
  uint8_t status;
...
# 122 "/opt/tinyos-2.x/tos/chips/cc2420/packet/CC2420PacketP.nc"
static void CC2420PacketP$PacketTimeStamp32khz$clear(message_t *msg)
{
...
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x4059e4a0){
#line 64
  switch (arg_0x4059e4a0) {
#line 64
    case RootNodeP$sendToUartTask:
#line 64
      RootNodeP$sendToUartTask$runTask();
#line 64
      break;
#line 64
    case ETXRoutingP$SendBeaconTask:
#line 64
      ETXRoutingP$SendBeaconTask$runTask();
#line 64
      break;
#line 64
    case ETXRoutingP$updateRouteETX:
#line 64
      ETXRoutingP$updateRouteETX$runTask();
#line 64
      break;
#line 64
    case ETXRoutingP$updateRouteRSSI:
#line 64
      ETXRoutingP$updateRouteRSSI$runTask();
#line 64
      break;
#line 64
    case ETXRoutingP$SendMonitorTask:
#line 64
      ETXRoutingP$SendMonitorTask$runTask();
#line 64
      break;
#line 64
    case ETXDataForwarderP$ForwardPacketsTask:
#line 64
      ETXDataForwarderP$ForwardPacketsTask$runTask();
#line 64
      break;
#line 64
    case ETXDataForwarderP$relayPacketTask:
#line 64
      ETXDataForwarderP$relayPacketTask$runTask();
#line 64
      break;
#line 64
    case ETXLinkLayerP$updateNeighborsTask:
#line 64
      ETXLinkLayerP$updateNeighborsTask$runTask();
#line 64
      break;
#line 64
...
#line 64
    default:
#line 64
      SchedulerBasicP$TaskBasic$default$runTask(arg_0x4059e4a0);
#line 64
      break;
#line 64
    }
...
#line 94
{
  if (err == SUCCESS) {
      { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
        if (p == RootNodeP$uartQueue[RootNodeP$uartOut]) {

            if (++RootNodeP$uartOut >= RootNodeP$UART_BUFFER_LEN) {
              RootNodeP$uartOut = 0;
              }
#line 101
            if (RootNodeP$uartFull) {
              RootNodeP$uartFull = FALSE;
              }
          }
#line 104
        __nesc_atomic_end(__nesc_atomic); }
...
# 67 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static am_addr_t ETXDataForwarderP$AMPacket$destination(message_t * amsg){
#line 67
  unsigned int result;
#line 67
...
# 157 "/opt/tinyos-2.x/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static void *CC2420CsmaP$Send$getPayload(message_t *m, uint8_t len)
#line 157
{
...
# 102 "/opt/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
static am_addr_t CC2420ActiveMessageP$AMPacket$source(message_t *amsg)
#line 102
{
  cc2420_header_t *header = CC2420ActiveMessageP$CC2420PacketBody$getHeader(amsg);
...
# 115 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static void * ETXRoutingP$Packet$getPayload(message_t * msg, uint8_t len){
#line 115
  void *result;
#line 115
...
#line 376
    {
      ETXRoutingP$routingTable[idx].active = 1;
      ETXRoutingP$routingTable[idx].ttl = 0;
      ETXRoutingP$routingTable[idx].src = (uint16_t )src_addr;
      ETXRoutingP$routingTable[idx].metric = __nesc_ntoh_uint8(b->metric.data);
      ETXRoutingP$routingTable[idx].parent = (uint16_t )__nesc_ntoh_uint16(b->parent.data);
      ETXRoutingP$routingTable[idx].rssi = rssi;
    }
#line 383
    __nesc_atomic_end(__nesc_atomic); }
}
...
# 412 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static void CC2420ReceiveP$waitForNextPacket(void )
#line 412
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 385 "/opt/tinyos-2.x/tos/chips/cc2420/receive/CC2420ReceiveP.nc"
static void CC2420ReceiveP$flush(void )
#line 385
{
  CC2420ReceiveP$reset_state();
...
# 673 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static void CC2420TransmitP$loadTXFIFO(void )
#line 673
{
...
# 298 "../ETXDataForwarderP.nc"
static void ETXDataForwarderP$SubSend$sendDone(message_t *p, error_t err)
#line 298
{
  if (err == SUCCESS) {
      ETXDataForwarderP$failCtr = 0;
      ETXDataForwarderP$sending = FALSE;
      ETXDataForwarderP$DataSend$sendDone(p, SUCCESS);
      return;
    }
  else 
#line 304
    {
      if (--ETXDataForwarderP$failCtr > 0) {
          ETXDataForwarderP$Routing$getNextHop(p, 1);
          if (ETXDataForwarderP$SubSend$send(ETXDataForwarderP$AMPacket$destination(p), p, ETXDataForwarderP$SubPacket$payloadLength(p)) == SUCCESS) {
              ;
            }
          return;
        }
...
#line 311
        if (ETXDataForwarderP$failCtr <= 0) {
            ETXDataForwarderP$failCtr = 0;
            ETXDataForwarderP$sending = FALSE;
            ETXDataForwarderP$DataSend$sendDone(p, FAIL);
            return;
          }
        }
    }
...
#line 227
  uint8_t k;
  uint16_t pkt_src = ETXRoutingP$AMPacket$source(p);
  routing_hdr_t *hdr = ETXRoutingP$getRoutingHeader(p);
  ...
  if (ETXRoutingP$nodeRole == ROUTER_ROLE) {
      if (__nesc_ntoh_uint16(hdr->orig_addr.data) != TOS_NODE_ID && opt == 0) {
          for (k = 0; k < 8; k++) {
              if (ETXRoutingP$duplicatedSenders[k] == pkt_src && ETXRoutingP$duplicatedSeqno[k] == __nesc_ntoh_uint16(hdr->seqno.data)) {
                  return FAIL;
                }
            }

          ETXRoutingP$duplicatedSenders[ETXRoutingP$duplicatedIdx] = pkt_src;
          ETXRoutingP$duplicatedSeqno[ETXRoutingP$duplicatedIdx] = __nesc_ntoh_uint16(hdr->seqno.data);
          ETXRoutingP$duplicatedIdx = (ETXRoutingP$duplicatedIdx + 1) % 8;

          for (k = 0; k < 8; k++) {
              if (ETXRoutingP$cyclicSenders[k] == __nesc_ntoh_uint16(hdr->orig_addr.data) && ETXRoutingP$cyclicSeqno[k] == __nesc_ntoh_uint16(hdr->seqno.data)) {
                  ETXRoutingP$currentETX = INVALID_ETX;
                  ETXRoutingP$currentRSSI = ETXRoutingP$INVALID_RSSI;
                  ETXRoutingP$currentParent = ETXRoutingP$INVALID_ADDR;
          ...
          ETXRoutingP$cyclicSenders[ETXRoutingP$cyclicIdx] = __nesc_ntoh_uint16(hdr->orig_addr.data);
          ETXRoutingP$cyclicSeqno[ETXRoutingP$cyclicIdx] = __nesc_ntoh_uint16(hdr->seqno.data);
          ETXRoutingP$cyclicIdx = (ETXRoutingP$cyclicIdx + 1) % 8;


          (__nesc_temp42 = hdr->hopcount.data, __nesc_hton_uint8(__nesc_temp42, (__nesc_temp43 = __nesc_ntoh_uint8(__nesc_temp42)) + 1), __nesc_temp43);
        }
    }

  ETXRoutingP$AMPacket$setDestination(p, ETXRoutingP$Routing$getParent());
...
#line 47
{
  /*MobilityC.DataSenderMine.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setDestination(msg, dest);
  /*MobilityC.DataSenderMine.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setType(msg, 201);
  return /*MobilityC.DataSenderMine.AMQueueEntryP*/AMQueueEntryP$2$Send$send(msg, len);
}
...
# 143 "../ETXDataForwarderP.nc"
static void ETXDataForwarderP$Forward$sendDone(message_t *p, error_t err)
#line 143
{

  if (p == ETXDataForwarderP$Queue[ETXDataForwarderP$queueOut]) {

      { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 147
        {
          ETXDataForwarderP$queueOut = (ETXDataForwarderP$queueOut + 1) % BUFR_QUEUE_LEN;
          if (ETXDataForwarderP$radioFull) {
            ETXDataForwarderP$radioFull = FALSE;
            }
        }
...
#line 152
    {
      if (--ETXDataForwarderP$maxRetrans > 0) {
          message_t *retMsg = ETXDataForwarderP$Queue[ETXDataForwarderP$queueOut];



          ETXDataForwarderP$Routing$getNextHop(retMsg, 2);
          ETXDataForwarderP$relayPacketTask$postTask();
          return;
        }
      else 
...
#line 163
            {
              ETXDataForwarderP$maxRetrans = 0;
              ETXDataForwarderP$queueOut = (ETXDataForwarderP$queueOut + 1) % BUFR_QUEUE_LEN;
              if (ETXDataForwarderP$radioFull) {
                ETXDataForwarderP$radioFull = FALSE;
                }
...
# 115 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static void * ETXDataForwarderP$SubPacket$getPayload(message_t * msg, uint8_t len){
#line 115
  void *result;
#line 115
...
#line 337
  for (idx = 0; idx < 8; idx++) {
      if (ETXLinkLayerP$neighbors[idx].from == addr) {
          return ETXLinkLayerP$neighbors[idx].e_etx;
        }
    }
...
# 85 "../ETXDataForwarderP.nc"
static error_t ETXDataForwarderP$Init$init(void )
#line 85
{
  ETXDataForwarderP$initialize();
  ETXDataForwarderP$SplitControl$start();
  ETXDataForwarderP$MonitorTimer$startPeriodic(7);
  return SUCCESS;
}
